...
//--------------------------------------------------------------------------------
//Tool Version: Vivado v.2019.2 (lin64) Build 2686236 Tue Oct  8 19:36:34 MDT 2019
//Date        : Wed Oct  9 11:55:27 2019
//Host        : xhdl160045 running 64-bit Red Hat Enterprise Linux Workstation release 7.4 (Maipo)
//Command     : generate_target zcu106_vcu_uc2_wrapper.bd
//Design      : zcu106_vcu_uc2_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module zcu106_llp2_nv16_wrapper
   (C0_DDR4_act_n,
    C0_DDR4_adr,
    C0_DDR4_ba,
    C0_DDR4_bg,
  ...
  input [0:0]si570_user_clk_n;
  input [0:0]si570_user_clk_p;
  ...
  wire [0:0]si570_user_clk_n;
  wire [0:0]si570_user_clk_p;
