...
set_property PACKAGE_PIN AN8 [get_ports si570_mclk_out]
set_property IOSTANDARD LVCMOS12 [get_ports si570_mclk_out]
...
#set_clock_groups -name clk_pl_async -asynchronous -group [get_clocks clk_out1_zcu106_bd_clk_wiz_1_0] -group [get_clocks clk_pl_0]
