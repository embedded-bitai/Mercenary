...
#set_max_delay -datapath_only -from [get_clocks clk_out2_i_bd_clk_wiz_0_0] -to [get_clocks clk_out1_i_bd_clk_wiz_0_0] 9.899
#set_max_delay -datapath_only -from [get_clocks clk_out1_i_bd_clk_wiz_0_0] -to [get_clocks clk_out2_i_bd_clk_wiz_0_0] -0.100
#create_generated_clock -name nidru_clk0 -source [get_pins {uhdsdi_demo/i_bd/compact_gt_wrapper/compact_gt/uhdsdi_gt_0/inst/GT_WRAPPER_INST/gen_multi_gt_channel[0].gt_channel_gthe4_inst.uhdsdi_link/inst/gen_gtwizard_gthe4_top.uhdsdi_gtwiz_gtwizard_gthe4_inst/gen_gtwizard_gthe4.gen_channel_container[0].gen_enabled_channel.gthe4_channel_wrapper_inst/channel_inst/gthe4_channel_gen.gen_gthe4_channel_inst[0].GTHE4_CHANNEL_PRIM_INST/RXOUTCLK}] -divide_by 2 [get_pins uhdsdi_demo/i_bd/compact_gt_wrapper/compact_gt/uhdsdi_gt_0/inst/uhdsdi_ctrl_0/GEN_NIDRU.NIDRU/Inst_dru/CLK]
create_generated_clock -name nidru_clk0 -source [get_pins -hier -filter name=~*GTHE4_CHANNEL_PRIM_INST/RXOUTCLK] -divide_by 2 [get_pins uhdsdi_demo/i_bd/compact_gt_wrapper/compact_gt/uhdsdi_gt_0/inst/uhdsdi_ctrl_0/GEN_NIDRU.NIDRU/Inst_dru/CLK]

#set_clock_groups -name async_grp4 -asynchronous -group [get_clocks clk_pl_0] -group [get_clocks [list  [get_clocks -of_objects [get_pins {uhdsdi_demo/i_bd/compact_gt_wrapper/compact_gt/uhdsdi_gt_0/inst/GT_WRAPPER_INST/gen_multi_gt_channel[0].gt_channel_gthe4_inst.uhdsdi_link/inst/gen_gtwizard_gthe4_top.uhdsdi_gtwiz_gtwizard_gthe4_inst/gen_gtwizard_gthe4.gen_channel_container[0].gen_enabled_channel.gthe4_channel_wrapper_inst/channel_inst/gthe4_channel_gen.gen_gthe4_channel_inst[0].GTHE4_CHANNEL_PRIM_INST/RXOUTCLK}]]]]
