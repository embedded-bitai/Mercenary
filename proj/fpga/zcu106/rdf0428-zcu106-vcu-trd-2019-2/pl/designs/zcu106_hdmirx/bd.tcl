...
proc create_hier_cell_hdmi_input { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 RX_DDC
  ...
  create_bd_pin -dir I RX_DET
  create_bd_pin -dir O RX_HPD
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins RX_DDC] [get_bd_intf_pins v_hdmi_rx_ss_0/DDC_OUT]
  ...
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins LINK_DATA0_IN] [get_bd_intf_pins v_hdmi_rx_ss_0/LINK_DATA0_IN]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins LINK_DATA1_IN] [get_bd_intf_pins v_hdmi_rx_ss_0/LINK_DATA1_IN]
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins LINK_DATA2_IN] [get_bd_intf_pins v_hdmi_rx_ss_0/LINK_DATA2_IN]
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins SB_STATUS_IN] [get_bd_intf_pins v_hdmi_rx_ss_0/SB_STATUS_IN]
  connect_bd_intf_net -intf_net Conn9 [get_bd_intf_pins S_AXI_CPU_IN] [get_bd_intf_pins v_hdmi_rx_ss_0/S_AXI_CPU_IN]
  ...
  connect_bd_intf_net -intf_net s_axi_ctrl_0_1 [get_bd_intf_pins s_axi_ctrl_0] [get_bd_intf_pins v_proc_ss_0/s_axi_ctrl]
  ...
  connect_bd_intf_net -intf_net v_proc_ss_1_m_axis [get_bd_intf_pins axis_broadcaster_0/S_AXIS] [get_bd_intf_pins v_proc_ss_0/m_axis]

  # Create port connections
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din]
  connect_bd_net -net RX_DET_1 [get_bd_pins RX_DET] [get_bd_pins v_hdmi_rx_ss_0/cable_detect]
  ...
  connect_bd_net -net s_axis_audio_aclk_1 [get_bd_pins s_axis_audio_aclk] [get_bd_pins v_hdmi_rx_ss_0/s_axi_cpu_aclk] [get_bd_pins v_hdmi_rx_ss_0/s_axis_audio_aclk]
  ...
  connect_bd_net -net v_hdmi_rx_ss_0_hpd [get_bd_pins RX_HPD] [get_bd_pins v_hdmi_rx_ss_0/hpd]
...
proc create_hier_cell_gpio_aresetn { parentCell nameHier } {
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_o [get_bd_pins Din] [get_bd_pins rx_scaler_reset/Din]
...
connect_bd_intf_net -intf_net SB_STATUS_IN_1 [get_bd_intf_pins tx_hdmi_hb_0/status_sb] [get_bd_intf_pins vid_phy_controller/vid_phy_status_sb_tx]
  ...
  connect_bd_intf_net -intf_net hdmi_input_RX_DDC [get_bd_intf_ports RX_DDC] [get_bd_intf_pins hdmi_input/RX_DDC]
  ...
  connect_bd_intf_net -intf_net vid_phy_controller_vid_phy_rx_axi4s_ch0 [get_bd_intf_pins hdmi_input/LINK_DATA0_IN] [get_bd_intf_pins vid_phy_controller/vid_phy_rx_axi4s_ch0]
  connect_bd_intf_net -intf_net vid_phy_controller_vid_phy_rx_axi4s_ch1 [get_bd_intf_pins hdmi_input/LINK_DATA1_IN] [get_bd_intf_pins vid_phy_controller/vid_phy_rx_axi4s_ch1]
  connect_bd_intf_net -intf_net vid_phy_controller_vid_phy_rx_axi4s_ch2 [get_bd_intf_pins hdmi_input/LINK_DATA2_IN] [get_bd_intf_pins vid_phy_controller/vid_phy_rx_axi4s_ch2]
  connect_bd_intf_net -intf_net vid_phy_controller_vid_phy_status_sb_rx [get_bd_intf_pins hdmi_input/SB_STATUS_IN] [get_bd_intf_pins vid_phy_controller/vid_phy_status_sb_rx]
connect_bd_intf_net -intf_net [get_bd_intf_nets vid_phy_controller_vid_phy_status_sb_rx] [get_bd_intf_pins hdmi_input/SB_STATUS_IN] [get_bd_intf_pins rx_hdmi_hb_0/status_sb]
  ...
  connect_bd_net -net Net [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins axi_interconnect_2/S01_ACLK] [get_bd_pins axi_interconnect_3/ACLK] [get_bd_pins axi_interconnect_3/M00_ACLK] [get_bd_pins axi_interconnect_3/S00_ACLK] [get_bd_pins axi_interconnect_4/ACLK] [get_bd_pins axi_interconnect_4/M00_ACLK] [get_bd_pins axi_interconnect_4/S00_ACLK] [get_bd_pins axi_interconnect_4/S01_ACLK] [get_bd_pins axi_interconnect_4/S02_ACLK] [get_bd_pins axi_interconnect_4/S03_ACLK] [get_bd_pins axi_interconnect_4/S04_ACLK] [get_bd_pins axi_interconnect_4/S05_ACLK] [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins hdmi_input/clk_300M] [get_bd_pins mpsoc_ss/s_axi_hpc0_fpd_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins vcu_0/m_axi_dec_aclk] [get_bd_pins vcu_0/m_axi_enc_aclk] [get_bd_pins vcu_0/m_axi_mcu_aclk]
  connect_bd_net -net RX_DET_1 [get_bd_ports RX_DET] [get_bd_pins hdmi_input/RX_DET]
  ...
  connect_bd_net -net aresetn_100M [get_bd_ports SI5319_RST] [get_bd_pins hdmi_input/s_axi_cpu_aresetn] [get_bd_pins mpsoc_ss/aresetn_100M] [get_bd_pins vid_phy_controller/vid_phy_axi4lite_aresetn] [get_bd_pins vid_phy_controller/vid_phy_sb_aresetn]
  connect_bd_net -net clk_100M [get_bd_pins hdmi_input/s_axis_audio_aclk] [get_bd_pins mpsoc_ss/clk_100M] [get_bd_pins rx_hdmi_hb_0/status_sb_aclk] [get_bd_pins tx_hdmi_hb_0/status_sb_aclk] [get_bd_pins vcu_0/s_axi_lite_aclk] [get_bd_pins vid_phy_controller/drpclk] [get_bd_pins vid_phy_controller/vid_phy_axi4lite_aclk] [get_bd_pins vid_phy_controller/vid_phy_sb_aclk]
  ...
  connect_bd_net -net gpio [get_bd_pins gpio_aresetn/Din] [get_bd_pins hdmi_input/Din] [get_bd_pins mpsoc_ss/gpio] [get_bd_pins vcu_rst/Din]
  ...
  connect_bd_net -net hdmi_input_RX_HPD [get_bd_ports RX_HPD] [get_bd_pins hdmi_input/RX_HPD]
  ...
  connect_bd_net -net pl_ps_irq1_1 [get_bd_pins interrupts1/dout] [get_bd_pins mpsoc_ss/pl_ps_irq1]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axi_interconnect_2/S01_ARESETN] [get_bd_pins axi_interconnect_3/ARESETN] [get_bd_pins axi_interconnect_3/M00_ARESETN] [get_bd_pins axi_interconnect_3/S00_ARESETN] [get_bd_pins axi_interconnect_4/ARESETN] [get_bd_pins axi_interconnect_4/M00_ARESETN] [get_bd_pins axi_interconnect_4/S00_ARESETN] [get_bd_pins axi_interconnect_4/S01_ARESETN] [get_bd_pins axi_interconnect_4/S02_ARESETN] [get_bd_pins axi_interconnect_4/S03_ARESETN] [get_bd_pins axi_interconnect_4/S04_ARESETN] [get_bd_pins axi_interconnect_4/S05_ARESETN] [get_bd_pins hdmi_input/aresetn_300M] [get_bd_pins mpsoc_ss/reset_333] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  connect_bd_net -net txoutclk [get_bd_pins tx_hdmi_hb_0/link_clk] [get_bd_pins vid_phy_controller/txoutclk] [get_bd_pins vid_phy_controller/vid_phy_tx_axi4s_aclk]
  ...
  connect_bd_net -net vid_phy_controller_rx_video_clk [get_bd_pins hdmi_input/video_clk] [get_bd_pins vid_phy_controller/rx_video_clk]
