...
proc create_hier_cell_zynq_us_ss { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__ACT_FREQMHZ {32.429192} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__DIVISOR0 {37} \
  ...
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins M07_AXI_0] [get_bd_intf_pins axi_interconnect_1/M07_AXI]
  ...
  connect_bd_intf_net -intf_net S_AXI_HP3_FPD_1 [get_bd_intf_pins S_AXI_HP3_FPD] [get_bd_intf_pins zynq_us/S_AXI_HP3_FPD]
  ...
  connect_bd_net -net In5_1 [get_bd_pins In5] [get_bd_pins xlconcat0/In7]
...
proc create_hier_cell_reset_generator { parentCell nameHier } {
  ...
  connect_bd_net -net and_1bit_Res [get_bd_pins Res] [get_bd_pins and_1bit/Res] [get_bd_pins reset_sys_clk/aux_reset_in]
  ...
  connect_bd_net -net reset_axilite_clk_mb_reset [get_bd_pins mb_reset] [get_bd_pins reset_axilite_clk/mb_reset]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins zynq_us_ss/S_AXI_HP3_FPD]
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_interconnect_1/M00_AXI] [get_bd_intf_pins zynq_us_ss/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net axi_interconnect_2_M00_AXI [get_bd_intf_pins axi_interconnect_2/M00_AXI] [get_bd_intf_pins zynq_us_ss/S_AXI_HP1_FPD]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_4_M00_AXI [get_bd_intf_pins axi_interconnect_4/M00_AXI] [get_bd_intf_pins zynq_us_ss/S_AXI_HP2_FPD]
  connect_bd_intf_net -intf_net sdi_tx_output_m_axi_mm_video [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins sdi_tx_output/m_axi_mm_video]
  ...
  connect_bd_intf_net -intf_net vcu_0_M_AXI_DEC1 [get_bd_intf_pins axi_interconnect_4/S00_AXI] [get_bd_intf_pins vcu_0/M_AXI_DEC1]
  ...
  connect_bd_net -net interconnect_aresetn_sys_clk [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axi_interconnect_0/S04_ARESETN] [get_bd_pins axi_interconnect_0/S05_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axi_interconnect_3/ARESETN] [get_bd_pins axi_interconnect_3/M00_ARESETN] [get_bd_pins axi_interconnect_3/S00_ARESETN] [get_bd_pins axi_interconnect_4/ARESETN] [get_bd_pins axi_interconnect_4/M00_ARESETN] [get_bd_pins axi_interconnect_4/S00_ARESETN] [get_bd_pins reset_generator/interconnect_aresetn_sys_clk]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins compact_gt_wrapper/drpclk] [get_bd_pins gpio_register/s_axi_aclk] [get_bd_pins gpio_resets/s_axi_aclk] [get_bd_pins reset_generator/s_axi_aclk] [get_bd_pins sdi_tx_output/s_axi_aclk] [get_bd_pins vcu_0/s_axi_lite_aclk] [get_bd_pins zynq_us_ss/s_axi_aclk]
  ...
  connect_bd_net -net reset_generator_peripheral_aresetn [get_bd_pins reset_generator/sys_rstn] [get_bd_pins sdi_tx_output/video_in_arstn]
  connect_bd_net -net reset_generator_peripheral_aresetn1 [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins compact_gt_wrapper/s_axi_aresetn] [get_bd_pins gpio_register/s_axi_aresetn] [get_bd_pins gpio_resets/s_axi_aresetn] [get_bd_pins reset_generator/peripheral_aresetn_lite] [get_bd_pins sdi_tx_output/s_axi_arstn] [get_bd_pins zynq_us_ss/s_axi_aresetn]
  ...
  connect_bd_net -net sys_clk [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axi_interconnect_0/S04_ACLK] [get_bd_pins axi_interconnect_0/S05_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins axi_interconnect_3/ACLK] [get_bd_pins axi_interconnect_3/M00_ACLK] [get_bd_pins axi_interconnect_3/S00_ACLK] [get_bd_pins axi_interconnect_4/ACLK] [get_bd_pins axi_interconnect_4/M00_ACLK] [get_bd_pins axi_interconnect_4/S00_ACLK] [get_bd_pins reset_generator/sys_clk] [get_bd_pins sdi_tx_output/video_in_clk] [get_bd_pins vcu_0/m_axi_dec_aclk] [get_bd_pins vcu_0/m_axi_enc_aclk] [get_bd_pins vcu_0/m_axi_mcu_aclk] [get_bd_pins zynq_us_ss/sys_clk]
  ...
  connect_bd_net -net vcu_resetn_1 [get_bd_pins reset_generator/pl_resetn] [get_bd_pins zynq_us_ss/pl_resetn0]
  connect_bd_net -net vcu_rst [get_bd_pins peripheral_aresetn_lite/vcu_rst] [get_bd_pins vcu_0/vcu_resetn]
  connect_bd_net -net vid_phy_controller_0_intf_0_rxoutclk [get_bd_ports rxoutclk] [get_bd_pins compact_gt_wrapper/intf_0_rxoutclk]
  connect_bd_net -net vid_phy_controller_0_intf_0_txn [get_bd_ports txn] [get_bd_pins compact_gt_wrapper/intf_0_txn]
  connect_bd_net -net vid_phy_controller_0_intf_0_txoutclk [get_bd_ports txoutclk] [get_bd_pins compact_gt_wrapper/intf_0_txoutclk] [get_bd_pins sdi_tx_output/txoutclk]
  connect_bd_net -net vid_phy_controller_0_intf_0_txp [get_bd_ports txp] [get_bd_pins compact_gt_wrapper/intf_0_txp]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins compact_gt_wrapper/intf_0_sb_rx_rst] [get_bd_pins sdi_tx_output/sdi_tx_rst] [get_bd_pins xlconstant_0/dout]
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP2/HP0_DDR_HIGH] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP2/HP0_DDR_LOW] -force
  ...
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP2/HP0_LPS_OCM] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP2/HP0_QSPI] -force
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces vcu_0/DecData0] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces vcu_0/DecData0] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces vcu_0/DecData0] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces vcu_0/DecData0] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces vcu_0/DecData1] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP4/HP2_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces vcu_0/DecData1] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces vcu_0/DecData1] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP4/HP2_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces vcu_0/DecData1] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP4/HP2_QSPI] -force
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces sdi_tx_output/v_frmbuf_rd_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_us_ss/zynq_us/SAXIGP5/HP3_DDR_HIGH]
