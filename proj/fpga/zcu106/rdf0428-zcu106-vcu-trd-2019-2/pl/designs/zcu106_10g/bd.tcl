...
proc create_hier_cell_mpsoc_ss { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn19 [get_bd_intf_pins M00_AXI1] [get_bd_intf_pins axi_interconnect_5/M00_AXI]
  ...
  connect_bd_intf_net -intf_net Conn24 [get_bd_intf_pins M01_AXI1] [get_bd_intf_pins axi_interconnect_5/M01_AXI]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins axi_interconnect_5/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect/ARESETN] [get_bd_pins axi_interconnect_5/ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net M17_ARESETN_1 [get_bd_pins reset_333] [get_bd_pins axi_interconnect/M03_ARESETN] [get_bd_pins axi_interconnect/M05_ARESETN] [get_bd_pins axi_interconnect/M06_ARESETN] [get_bd_pins axi_interconnect/M07_ARESETN] [get_bd_pins axi_interconnect/M09_ARESETN] [get_bd_pins axi_interconnect/M10_ARESETN] [get_bd_pins axi_interconnect/M13_ARESETN] [get_bd_pins axi_interconnect/M14_ARESETN] [get_bd_pins axi_interconnect/M15_ARESETN] [get_bd_pins axi_interconnect/M16_ARESETN] [get_bd_pins axi_interconnect/M17_ARESETN] [get_bd_pins axi_interconnect/M19_ARESETN] [get_bd_pins axi_interconnect/M20_ARESETN] [get_bd_pins axi_interconnect/M22_ARESETN] [get_bd_pins axi_interconnect/M23_ARESETN]
  connect_bd_net -net hdmi_ctrl_iic_iic2intc_irpt [get_bd_pins iic2intc_irpt] [get_bd_pins hdmi_ctrl_iic/iic2intc_irpt]
  connect_bd_net -net net_clk_wiz_clk_out1 [get_bd_pins clk_100M] [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M04_ACLK] [get_bd_pins axi_interconnect/M08_ACLK] [get_bd_pins axi_interconnect/M11_ACLK] [get_bd_pins axi_interconnect/M12_ACLK] [get_bd_pins axi_interconnect/M18_ACLK] [get_bd_pins axi_interconnect/M21_ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins axi_interconnect_5/ACLK] [get_bd_pins axi_interconnect_5/M00_ACLK] [get_bd_pins axi_interconnect_5/M01_ACLK] [get_bd_pins axi_interconnect_5/S00_ACLK] [get_bd_pins hdmi_ctrl_iic/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net net_rst_processor_1_100M_peripheral_aresetn [get_bd_pins aresetn_100M] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M04_ARESETN] [get_bd_pins axi_interconnect/M08_ARESETN] [get_bd_pins axi_interconnect/M11_ARESETN] [get_bd_pins axi_interconnect/M12_ARESETN] [get_bd_pins axi_interconnect/M18_ARESETN] [get_bd_pins axi_interconnect/M21_ARESETN] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins axi_interconnect_5/M00_ARESETN] [get_bd_pins axi_interconnect_5/M01_ARESETN] [get_bd_pins axi_interconnect_5/S00_ARESETN] [get_bd_pins hdmi_ctrl_iic/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
...
proc create_hier_cell_hdmi_input { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins M_AXI_0] [get_bd_intf_pins axi_data_fifo_1/M_AXI]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins s_axi_CTRL_1] [get_bd_intf_pins v_frmbuf_wr_1/s_axi_CTRL]
  ...
  connect_bd_intf_net -intf_net s_axi_CTRL1_1 [get_bd_intf_pins s_axi_CTRL1] [get_bd_intf_pins v_frmbuf_wr_2/s_axi_CTRL]
  ...
  connect_bd_net -net aresetn_100M [get_bd_pins aresetn_100M] [get_bd_pins v_hdmi_rx_ss_0/s_axi_cpu_aresetn]
  connect_bd_net -net aresetn_300M [get_bd_pins aresetn_300M] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins v_hdmi_rx_ss_0/s_axis_video_aresetn]
  connect_bd_net -net cable_detect [get_bd_pins cable_detect] [get_bd_pins v_hdmi_rx_ss_0/cable_detect]
  connect_bd_net -net clk_100M [get_bd_pins clk_100M] [get_bd_pins v_hdmi_rx_ss_0/s_axi_cpu_aclk] [get_bd_pins v_hdmi_rx_ss_0/s_axis_audio_aclk]
  connect_bd_net -net clk_300M [get_bd_pins clk_300M] [get_bd_pins axi_data_fifo_0/aclk] [get_bd_pins axi_data_fifo_1/aclk] [get_bd_pins axi_data_fifo_2/aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins axis_data_fifo_2/s_axis_aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins v_frmbuf_wr_0/ap_clk] [get_bd_pins v_frmbuf_wr_1/ap_clk] [get_bd_pins v_frmbuf_wr_2/ap_clk] [get_bd_pins v_hdmi_rx_ss_0/s_axis_video_aclk] [get_bd_pins v_proc_ss_0/aclk_axis] [get_bd_pins v_proc_ss_0/aclk_ctrl]
  connect_bd_net -net link_clk [get_bd_pins link_clk] [get_bd_pins v_hdmi_rx_ss_0/link_clk]
  connect_bd_net -net rx_scaler_reset [get_bd_pins frmbuf_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins axis_data_fifo_2/s_axis_aresetn] [get_bd_pins v_proc_ss_0/aresetn_ctrl]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins axis_register_slice_0/m_axis_tready] [get_bd_pins axis_register_slice_1/m_axis_tready] [get_bd_pins axis_register_slice_2/m_axis_tready] [get_bd_pins util_vector_logic_1/Res]
...
# Hierarchical cell: eth_sys
proc create_hier_cell_eth_sys { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_eth_sys() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir I -from 0 -to 0 periph_reset_n
  create_bd_pin -dir I -from 0 -to 0 pl_reset_n
  create_bd_pin -dir O -type clk rx_clk_out_0
  create_bd_pin -dir O -from 0 -to 0 rx_reset_n
  create_bd_pin -dir O -type intr s2mm_introut
  create_bd_pin -dir I -type clk s_axi_aclk_0
  create_bd_pin -dir O -from 0 -to 0 sfp_tx_disable
  create_bd_pin -dir I -type rst sys_reset
  create_bd_pin -dir O -type clk tx_clk_out_0
  create_bd_pin -dir O -from 0 -to 0 tx_reset_n
  ...
  # Create instance: const_1b_zero_0, and set properties
  set const_1b_zero_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant const_1b_zero_0 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $const_1b_zero_0

  # Create instance: const_3b_five, and set properties
  set const_3b_five [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant const_3b_five ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {5} \
   CONFIG.CONST_WIDTH {3} \
 ] $const_3b_five

  # Create instance: const_56b_zero, and set properties
  set const_56b_zero [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant const_56b_zero ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
  ...
  set eth_rx_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo eth_rx_fifo ]
  set_property -dict [ list \
  ...
  set eth_tx_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo eth_tx_fifo ]
  set_property -dict [ list \
   CONFIG.FIFO_DEPTH {8192} \
   CONFIG.FIFO_MODE {2} \
   CONFIG.HAS_RD_DATA_COUNT {0} \
  ...
  set pl_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic pl_reset ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {not} \
   CONFIG.C_SIZE {1} \
   CONFIG.LOGO_FILE {data/sym_notgate.png} \
  ...
  set sfp_tx_dis [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant sfp_tx_dis ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $sfp_tx_dis
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins eth_tx_fifo/S_AXIS]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins axi_dma_0/M_AXI_S2MM]
  connect_bd_intf_net -intf_net dma_axilite [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net eth_axilite [get_bd_intf_pins s_axi_0] [get_bd_intf_pins xxv_ethernet_0/s_axi_0]
  connect_bd_intf_net -intf_net eth_rx_fifo_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins eth_rx_fifo/M_AXIS]
  connect_bd_intf_net -intf_net eth_tx_fifo_M_AXIS [get_bd_intf_pins eth_tx_fifo/M_AXIS] [get_bd_intf_pins xxv_ethernet_0/axis_tx_0]
  connect_bd_intf_net -intf_net gt_ref_clk_0_1 [get_bd_intf_pins gt_ref_clk_0] [get_bd_intf_pins xxv_ethernet_0/gt_ref_clk]
  connect_bd_intf_net -intf_net xxv_ethernet_0_axis_rx_0 [get_bd_intf_pins eth_rx_fifo/S_AXIS] [get_bd_intf_pins xxv_ethernet_0/axis_rx_0]
  ...
  # Create port connections
  connect_bd_net -net aresetn_100M1 [get_bd_pins periph_reset_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins xxv_ethernet_0/s_axi_aresetn_0]
  ...
  connect_bd_net -net clk_100M1 [get_bd_pins s_axi_aclk_0] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins xxv_ethernet_0/dclk] [get_bd_pins xxv_ethernet_0/s_axi_aclk_0]
  connect_bd_net -net const_1b_zero_0_dout [get_bd_pins const_1b_zero_0/dout] [get_bd_pins xxv_ethernet_0/ctl_tx_send_idle_0] [get_bd_pins xxv_ethernet_0/ctl_tx_send_lfi_0] [get_bd_pins xxv_ethernet_0/ctl_tx_send_rfi_0]
  connect_bd_net -net const_3b_five_dout [get_bd_pins const_3b_five/dout] [get_bd_pins xxv_ethernet_0/rxoutclksel_in_0] [get_bd_pins xxv_ethernet_0/txoutclksel_in_0]
  connect_bd_net -net const_56b_zero_dout [get_bd_pins const_56b_zero/dout] [get_bd_pins xxv_ethernet_0/tx_preamblein_0]
  ...
  connect_bd_net -net mpsoc_ss_pl_resetn0_1 [get_bd_pins pl_reset_n] [get_bd_pins pl_reset/Op1]
  ...
  connect_bd_net -net rx_rst_n [get_bd_pins rx_reset_n] [get_bd_pins eth_rx_fifo/s_axis_aresetn] [get_bd_pins rx_rst_n/Res]
  connect_bd_net -net sfp_tx_dis_dout [get_bd_pins sfp_tx_disable] [get_bd_pins sfp_tx_dis/dout]
  connect_bd_net -net sys_reset_1 [get_bd_pins sys_reset] [get_bd_pins xxv_ethernet_0/sys_reset]
  connect_bd_net -net tx_rst_n_Res [get_bd_pins tx_reset_n] [get_bd_pins eth_tx_fifo/s_axis_aresetn] [get_bd_pins tx_rst_n/Res]
  connect_bd_net -net xxv_ethernet_0_rx_clk_out_0 [get_bd_pins rx_clk_out_0] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins eth_rx_fifo/s_axis_aclk] [get_bd_pins xxv_ethernet_0/rx_clk_out_0] [get_bd_pins xxv_ethernet_0/rx_core_clk_0]
  connect_bd_net -net xxv_ethernet_0_tx_clk_out_0 [get_bd_pins tx_clk_out_0] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins eth_tx_fifo/s_axis_aclk] [get_bd_pins xxv_ethernet_0/tx_clk_out_0]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {161.050} \
   CONFIG.CLKOUT1_PHASE_ERROR {192.037} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {33.33} \
   CONFIG.CLKOUT2_JITTER {125.058} \
   CONFIG.CLKOUT2_PHASE_ERROR {192.037} \
   ...
   CONFIG.MMCM_CLKFBOUT_MULT_F {55.125} \
   CONFIG.MMCM_CLKIN1_PERIOD {3.333} \
   CONFIG.MMCM_CLKIN2_PERIOD {10.0} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {45.125} \
  ...
  # Create instance: eth_sys
  create_hier_cell_eth_sys [current_bd_instance .] eth_sys
  ...
  connect_bd_intf_net -intf_net S04_AXI_1 [get_bd_intf_pins axi_interconnect_4/S04_AXI] [get_bd_intf_pins hdmi_input/M_AXI_0]
  connect_bd_intf_net -intf_net S05_AXI_1 [get_bd_intf_pins axi_interconnect_4/S05_AXI] [get_bd_intf_pins hdmi_input/M_AXI1]
  connect_bd_intf_net -intf_net S09_AXI_1 [get_bd_intf_pins axi_interconnect_0/S09_AXI] [get_bd_intf_pins eth_sys/M_AXI_MM2S]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets SB_STATUS_IN_1] [get_bd_intf_pins hdmi_output/SB_STATUS] [get_bd_intf_pins tx_hdmi_hb_0/status_sb]
  connect_bd_intf_net -intf_net S_AXI_HP3_FPD_0_1 [get_bd_intf_pins axi_interconnect_2/M00_AXI] [get_bd_intf_pins mpsoc_ss/S_AXI_HP3_FPD_0]
  connect_bd_intf_net -intf_net S_AXI_LITE_1 [get_bd_intf_pins eth_sys/S_AXI_LITE] [get_bd_intf_pins mpsoc_ss/M00_AXI1]
  ...
  connect_bd_intf_net -intf_net eth_sys_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_4/S03_AXI] [get_bd_intf_pins eth_sys/M_AXI_S2MM]
  connect_bd_intf_net -intf_net eth_sys_M_AXI_SG [get_bd_intf_pins axi_interconnect_0/S08_AXI] [get_bd_intf_pins eth_sys/M_AXI_SG]
  connect_bd_intf_net -intf_net gt_ref_clk_0_1 [get_bd_intf_ports gt_ref_clk_0] [get_bd_intf_pins eth_sys/gt_ref_clk_0]
  connect_bd_intf_net -intf_net hdmi_input_M_AXI [get_bd_intf_pins axi_interconnect_4/S00_AXI] [get_bd_intf_pins hdmi_input/M_AXI]
  ...
  connect_bd_intf_net -intf_net intf_net_zynq_ss_0_M00_AXI [get_bd_intf_pins mpsoc_ss/M00_AXI] [get_bd_intf_pins vid_phy_controller/vid_phy_axi4lite]
  connect_bd_intf_net -intf_net mpsoc_ss_M01_AXI [get_bd_intf_pins hdmi_input/S_AXI_CPU] [get_bd_intf_pins mpsoc_ss/M01_AXI]
  connect_bd_intf_net -intf_net mpsoc_ss_M02_AXI [get_bd_intf_pins hdmi_output/S_AXI_CPU] [get_bd_intf_pins mpsoc_ss/M02_AXI]
  connect_bd_intf_net -intf_net mpsoc_ss_M03_AXI [get_bd_intf_pins hdmi_input/s_axi_CTRL] [get_bd_intf_pins mpsoc_ss/M03_AXI]
  connect_bd_intf_net -intf_net mpsoc_ss_M05_AXI [get_bd_intf_pins hdmi_output/s_axi_ctrl_frm_rd] [get_bd_intf_pins mpsoc_ss/M05_AXI]
  connect_bd_intf_net -intf_net mpsoc_ss_M06_AXI [get_bd_intf_pins hdmi_input/s_axi_ctrl_0] [get_bd_intf_pins mpsoc_ss/M06_AXI]
  connect_bd_intf_net -intf_net mpsoc_ss_M07_AXI_0 [get_bd_intf_pins hdmi_output/s_axi_ctrl_mixer] [get_bd_intf_pins mpsoc_ss/M07_AXI_0]
  connect_bd_intf_net -intf_net mpsoc_ss_M08_AXI_0 [get_bd_intf_pins mpsoc_ss/M08_AXI_0] [get_bd_intf_pins vcu_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net mpsoc_ss_M22_AXI_0 [get_bd_intf_pins hdmi_input/s_axi_CTRL_1] [get_bd_intf_pins mpsoc_ss/M22_AXI_0]
  connect_bd_intf_net -intf_net mpsoc_ss_M23_AXI [get_bd_intf_pins hdmi_input/s_axi_CTRL1] [get_bd_intf_pins mpsoc_ss/M23_AXI]
  connect_bd_intf_net -intf_net s_axi_0_1 [get_bd_intf_pins eth_sys/s_axi_0] [get_bd_intf_pins mpsoc_ss/M01_AXI1]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets vid_phy_controller_vid_phy_status_sb_rx] [get_bd_intf_pins hdmi_input/SB_STATUS] [get_bd_intf_pins rx_hdmi_hb_0/status_sb]
  connect_bd_intf_net -intf_net xxv_ethernet_0_gt_serial_port [get_bd_intf_ports gt_serial_port_0] [get_bd_intf_pins eth_sys/gt_serial_port_0]
  ...
  connect_bd_net -net Net [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axi_interconnect_0/S04_ACLK] [get_bd_pins axi_interconnect_0/S05_ACLK] [get_bd_pins axi_interconnect_0/S06_ACLK] [get_bd_pins axi_interconnect_0/S07_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins axi_interconnect_2/S01_ACLK] [get_bd_pins axi_interconnect_3/ACLK] [get_bd_pins axi_interconnect_3/M00_ACLK] [get_bd_pins axi_interconnect_3/S00_ACLK] [get_bd_pins axi_interconnect_4/ACLK] [get_bd_pins axi_interconnect_4/M00_ACLK] [get_bd_pins axi_interconnect_4/S00_ACLK] [get_bd_pins axi_interconnect_4/S01_ACLK] [get_bd_pins axi_interconnect_4/S02_ACLK] [get_bd_pins axi_interconnect_4/S04_ACLK] [get_bd_pins axi_interconnect_4/S05_ACLK] [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins hdmi_input/clk_300M] [get_bd_pins hdmi_output/clk_300M] [get_bd_pins mpsoc_ss/s_axi_hpc0_fpd_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins vcu_0/m_axi_dec_aclk] [get_bd_pins vcu_0/m_axi_enc_aclk] [get_bd_pins vcu_0/m_axi_mcu_aclk]
  ...
  connect_bd_net -net S09_ACLK_1 [get_bd_pins axi_interconnect_0/S09_ACLK] [get_bd_pins eth_sys/tx_clk_out_0]
  connect_bd_net -net S09_ARESETN_1 [get_bd_pins axi_interconnect_0/S09_ARESETN] [get_bd_pins eth_sys/tx_reset_n]
  ...
  connect_bd_net -net aresetn_100M [get_bd_ports SI5319_RST] [get_bd_pins axi_interconnect_0/S08_ARESETN] [get_bd_pins eth_sys/periph_reset_n] [get_bd_pins hdmi_input/aresetn_100M] [get_bd_pins hdmi_output/aresetn_100M] [get_bd_pins mpsoc_ss/aresetn_100M] [get_bd_pins vid_phy_controller/vid_phy_axi4lite_aresetn] [get_bd_pins vid_phy_controller/vid_phy_sb_aresetn]
  connect_bd_net -net clk_100M [get_bd_pins axi_interconnect_0/S08_ACLK] [get_bd_pins eth_sys/s_axi_aclk_0] [get_bd_pins hdmi_input/clk_100M] [get_bd_pins hdmi_output/clk_100M] [get_bd_pins mpsoc_ss/clk_100M] [get_bd_pins rx_hdmi_hb_0/status_sb_aclk] [get_bd_pins tx_hdmi_hb_0/status_sb_aclk] [get_bd_pins vcu_0/s_axi_lite_aclk] [get_bd_pins vid_phy_controller/drpclk] [get_bd_pins vid_phy_controller/vid_phy_axi4lite_aclk] [get_bd_pins vid_phy_controller/vid_phy_sb_aclk]
  ...
  connect_bd_net -net eth_sys_mm2s_introut [get_bd_pins eth_sys/mm2s_introut] [get_bd_pins interrupts1/In7]
  connect_bd_net -net eth_sys_rx_clk_out_0 [get_bd_pins axi_interconnect_4/S03_ACLK] [get_bd_pins eth_sys/rx_clk_out_0]
  connect_bd_net -net eth_sys_rx_reset_n [get_bd_pins axi_interconnect_4/S03_ARESETN] [get_bd_pins eth_sys/rx_reset_n]
  connect_bd_net -net eth_sys_s2mm_introut [get_bd_pins eth_sys/s2mm_introut] [get_bd_pins interrupts1/In4]
  ...
  connect_bd_net -net gpio [get_bd_pins gpio_aresetn/Din] [get_bd_pins hdmi_input/Din] [get_bd_pins hdmi_output/Din] [get_bd_pins mpsoc_ss/gpio] [get_bd_pins vcu_rst/Din]
  ...
  connect_bd_net -net mpsoc_ss_pl_resetn0_0 [get_bd_pins eth_sys/pl_reset_n] [get_bd_pins mpsoc_ss/pl_resetn0_0] [get_bd_pins proc_sys_reset_1/ext_reset_in]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axi_interconnect_0/S04_ARESETN] [get_bd_pins axi_interconnect_0/S05_ARESETN] [get_bd_pins axi_interconnect_0/S06_ARESETN] [get_bd_pins axi_interconnect_0/S07_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axi_interconnect_2/S01_ARESETN] [get_bd_pins axi_interconnect_3/ARESETN] [get_bd_pins axi_interconnect_3/M00_ARESETN] [get_bd_pins axi_interconnect_3/S00_ARESETN] [get_bd_pins axi_interconnect_4/ARESETN] [get_bd_pins axi_interconnect_4/M00_ARESETN] [get_bd_pins axi_interconnect_4/S00_ARESETN] [get_bd_pins axi_interconnect_4/S01_ARESETN] [get_bd_pins axi_interconnect_4/S02_ARESETN] [get_bd_pins axi_interconnect_4/S04_ARESETN] [get_bd_pins axi_interconnect_4/S05_ARESETN] [get_bd_pins hdmi_input/aresetn_300M] [get_bd_pins hdmi_output/aresetn_300M] [get_bd_pins mpsoc_ss/reset_333] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  connect_bd_net -net sfp_tx_dis_dout [get_bd_ports sfp_tx_disable] [get_bd_pins eth_sys/sfp_tx_disable]
  connect_bd_net -net sys_reset_1 [get_bd_pins eth_sys/sys_reset] [get_bd_pins mpsoc_ss/peripheral_reset]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces eth_sys/axi_dma_0/Data_SG] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces eth_sys/axi_dma_0/Data_MM2S] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces eth_sys/axi_dma_0/Data_SG] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces eth_sys/axi_dma_0/Data_MM2S] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces eth_sys/axi_dma_0/Data_SG] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces eth_sys/axi_dma_0/Data_MM2S] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces eth_sys/axi_dma_0/Data_S2MM] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces eth_sys/axi_dma_0/Data_S2MM] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces eth_sys/axi_dma_0/Data_S2MM] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_2/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_2/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_2/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_2/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video5] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video1] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video2] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video7] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video4] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video3] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video6] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs eth_sys/axi_dma_0/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0xA02B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_input/v_frmbuf_wr_1/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA02C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_input/v_frmbuf_wr_2/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0x80010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs eth_sys/xxv_ethernet_0/s_axi_0/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces eth_sys/axi_dma_0/Data_MM2S] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces eth_sys/axi_dma_0/Data_S2MM] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces eth_sys/axi_dma_0/Data_SG] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
