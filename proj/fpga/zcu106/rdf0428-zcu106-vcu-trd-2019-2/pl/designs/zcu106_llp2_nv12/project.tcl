...
# local variables
set design_nm "${::platform}_llp2_nv12"
...
add_files -fileset constrs_1 -norecurse $constrs_dir/vcu_trd.xdc
add_files -fileset constrs_1 -norecurse $constrs_dir/vcu_trd_async.xdc
set_property used_in_synthesis false [get_files  vcu_trd_async.xdc]
