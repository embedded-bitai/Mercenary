...
proc create_hier_cell_mpsoc_ss { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 2 -to 0 -type intr pl_ps_irq1
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins clk_300_aresetn] [get_bd_pins axi_interconnect/M15_ARESETN] [get_bd_pins axi_interconnect/M16_ARESETN] [get_bd_pins axi_interconnect/M17_ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net saxihp2_fpd_aclk_0_1 [get_bd_pins s_axi_hpc0_fpd_aclk] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins axi_interconnect/M05_ACLK] [get_bd_pins axi_interconnect/M06_ACLK] [get_bd_pins axi_interconnect/M07_ACLK] [get_bd_pins axi_interconnect/M09_ACLK] [get_bd_pins axi_interconnect/M10_ACLK] [get_bd_pins axi_interconnect/M13_ACLK] [get_bd_pins axi_interconnect/M14_ACLK] [get_bd_pins axi_interconnect/M19_ACLK] [get_bd_pins axi_interconnect/M20_ACLK] [get_bd_pins axi_interconnect/M21_ACLK] [get_bd_pins axi_interconnect/M22_ACLK] [get_bd_pins axi_interconnect/M23_ACLK] [get_bd_pins axi_interconnect/M24_ACLK] [get_bd_pins axi_interconnect/M25_ACLK] [get_bd_pins axi_interconnect/M26_ACLK] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp3_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_o [get_bd_pins gpio] [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins clk_300M] [get_bd_pins axi_interconnect/M15_ACLK] [get_bd_pins axi_interconnect/M16_ACLK] [get_bd_pins axi_interconnect/M17_ACLK] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1]
...
proc create_hier_cell_hdmi_input { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.M02_TUSER_REMAP {tuser[0:0]} \
   CONFIG.M03_TDATA_REMAP {tdata[63:0]} \
   CONFIG.M03_TUSER_REMAP {tuser[0:0]} \
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins s_axi_CTRL_0] [get_bd_intf_pins v_frmbuf_wr_1/s_axi_CTRL]
  ...
  # Create port connections
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din]
  connect_bd_net -net aresetn_1_1 [get_bd_pins aresetn_1] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn]
  ...
  connect_bd_net -net clk_300M [get_bd_pins clk_300M] [get_bd_pins axi_data_fifo_0/aclk] [get_bd_pins axi_data_fifo_1/aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins v_frmbuf_wr_0/ap_clk] [get_bd_pins v_frmbuf_wr_1/ap_clk] [get_bd_pins v_hdmi_rx_ss_0/s_axis_video_aclk] [get_bd_pins v_proc_ss_0/aclk_axis] [get_bd_pins v_proc_ss_0/aclk_ctrl]
  ...
  connect_bd_net -net rx_scaler_reset [get_bd_pins frmbuf_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins v_proc_ss_0/aresetn_ctrl]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins axis_register_slice_0/m_axis_tready] [get_bd_pins axis_register_slice_1/m_axis_tready] [get_bd_pins util_vector_logic_0/Res]
  ...
  connect_bd_net -net xlslice_2_Dout [get_bd_pins axi_data_fifo_1/aresetn] [get_bd_pins v_frmbuf_wr_1/ap_rst_n] [get_bd_pins xlslice_2/Dout]
...
proc create_hier_cell_gpio_aresetn { parentCell nameHier } {
  ...
  set tx_frmbuf_rd_aresetn_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice tx_frmbuf_rd_aresetn_2 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {90} \
   CONFIG.DIN_TO {90} \
   CONFIG.DIN_WIDTH {95} \
...
# Hierarchical cell: LLP2_PHASE2_LOW_LATENCY_BLOCK
proc create_hier_cell_LLP2_PHASE2_LOW_LATENCY_BLOCK { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_LLP2_PHASE2_LOW_LATENCY_BLOCK() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_MM_P_1
  ...
  create_bd_pin -dir O -from 0 -to 0 -type intr host_irq1
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_AXI_MM_P_1] [get_bd_intf_pins sync_ip_0/S_AXI_MM_P_1]
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_interconnect_8/S00_AXI] [get_bd_intf_pins sync_ip_0/M_AXI_MM_1]
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins S_AXI_MM_P_0] [get_bd_intf_pins sync_ip_0/S_AXI_MM_P_0]
  connect_bd_intf_net -intf_net S_AXI_HP1_FPD_0_1 [get_bd_intf_pins M00_AXI2] [get_bd_intf_pins axi_interconnect_7/M00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins M00_AXI1] [get_bd_intf_pins axi_interconnect_2/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_interconnect_1/M00_AXI] [get_bd_intf_pins axi_interconnect_9/S00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_3_M00_AXI [get_bd_intf_pins axi_interconnect_3/M00_AXI] [get_bd_intf_pins axi_interconnect_4/S00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_4_M00_AXI [get_bd_intf_pins axi_interconnect_4/M00_AXI] [get_bd_intf_pins sync_ip_0/S_AXI_MM_1]
  connect_bd_intf_net -intf_net axi_interconnect_8_M00_AXI [get_bd_intf_pins M00_AXI3] [get_bd_intf_pins axi_interconnect_8/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_9_M00_AXI [get_bd_intf_pins axi_interconnect_9/M00_AXI] [get_bd_intf_pins sync_ip_0/S_AXI_MM_0]
  connect_bd_intf_net -intf_net mpsoc_ss_M14_AXI_0 [get_bd_intf_pins S_AXI_CTRL] [get_bd_intf_pins sync_ip_0/S_AXI_CTRL]
  connect_bd_intf_net -intf_net sync_ip_0_M_AXI_MM_0 [get_bd_intf_pins axi_interconnect_7/S00_AXI] [get_bd_intf_pins sync_ip_0/M_AXI_MM_0]
  connect_bd_intf_net -intf_net vcu_0_M_AXI_DEC0 [get_bd_intf_pins S00_AXI2] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net vcu_0_M_AXI_DEC1 [get_bd_intf_pins S00_AXI] [get_bd_intf_pins axi_interconnect_2/S00_AXI]
  connect_bd_intf_net -intf_net vcu_0_M_AXI_ENC0 [get_bd_intf_pins S00_AXI3] [get_bd_intf_pins axi_interconnect_1/S00_AXI]
  connect_bd_intf_net -intf_net vcu_0_M_AXI_ENC1 [get_bd_intf_pins S00_AXI1] [get_bd_intf_pins axi_interconnect_3/S00_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins axi_interconnect_3/ACLK] [get_bd_pins axi_interconnect_3/M00_ACLK] [get_bd_pins axi_interconnect_3/S00_ACLK] [get_bd_pins axi_interconnect_4/ACLK] [get_bd_pins axi_interconnect_4/M00_ACLK] [get_bd_pins axi_interconnect_4/S00_ACLK] [get_bd_pins axi_interconnect_7/ACLK] [get_bd_pins axi_interconnect_7/M00_ACLK] [get_bd_pins axi_interconnect_7/S00_ACLK] [get_bd_pins axi_interconnect_8/ACLK] [get_bd_pins axi_interconnect_8/M00_ACLK] [get_bd_pins axi_interconnect_8/S00_ACLK] [get_bd_pins axi_interconnect_9/ACLK] [get_bd_pins axi_interconnect_9/M00_ACLK] [get_bd_pins axi_interconnect_9/S00_ACLK] [get_bd_pins sync_ip_0/s_axi_ctrl_aclk] [get_bd_pins sync_ip_0/s_axi_mm_aclk] [get_bd_pins sync_ip_0/s_axi_mm_p_aclk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axi_interconnect_3/ARESETN] [get_bd_pins axi_interconnect_3/M00_ARESETN] [get_bd_pins axi_interconnect_3/S00_ARESETN] [get_bd_pins axi_interconnect_4/ARESETN] [get_bd_pins axi_interconnect_4/M00_ARESETN] [get_bd_pins axi_interconnect_4/S00_ARESETN] [get_bd_pins axi_interconnect_7/ARESETN] [get_bd_pins axi_interconnect_7/M00_ARESETN] [get_bd_pins axi_interconnect_7/S00_ARESETN] [get_bd_pins axi_interconnect_8/ARESETN] [get_bd_pins axi_interconnect_8/M00_ARESETN] [get_bd_pins axi_interconnect_8/S00_ARESETN] [get_bd_pins axi_interconnect_9/ARESETN] [get_bd_pins axi_interconnect_9/M00_ARESETN] [get_bd_pins axi_interconnect_9/S00_ARESETN] [get_bd_pins sync_ip_0/s_axi_ctrl_aresetn] [get_bd_pins sync_ip_0/s_axi_mm_aresetn] [get_bd_pins sync_ip_0/s_axi_mm_p_aresetn]
  connect_bd_net -net sync_ip_0_host_irq [get_bd_pins host_irq] [get_bd_pins sync_ip_0/host_irq]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins host_irq1] [get_bd_pins xlconstant_0/dout]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: LLP2_PHASE2_LOW_LATENCY_BLOCK
  create_hier_cell_LLP2_PHASE2_LOW_LATENCY_BLOCK [current_bd_instance .] LLP2_PHASE2_LOW_LATENCY_BLOCK
...
connect_bd_intf_net -intf_net [get_bd_intf_nets SB_STATUS_IN_1] [get_bd_intf_pins hdmi_output/SB_STATUS] [get_bd_intf_pins tx_hdmi_hb_0/status_sb]
  ...
  connect_bd_intf_net -intf_net S_AXI_CTRL_1 [get_bd_intf_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/S_AXI_CTRL] [get_bd_intf_pins mpsoc_ss/M14_AXI_0]
  connect_bd_intf_net -intf_net S_AXI_HP1_FPD_0_1 [get_bd_intf_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/M00_AXI2] [get_bd_intf_pins mpsoc_ss/S_AXI_HP1_FPD_0]
  connect_bd_intf_net -intf_net S_AXI_HP3_FPD_0_1 [get_bd_intf_pins axi_interconnect_6/M00_AXI] [get_bd_intf_pins mpsoc_ss/S_AXI_HP3_FPD_0]
  connect_bd_intf_net -intf_net TX_DDC [get_bd_intf_ports TX_DDC] [get_bd_intf_pins hdmi_output/DDC]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/M00_AXI] [get_bd_intf_pins axi_interconnect_6/S00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/M00_AXI1] [get_bd_intf_pins axi_interconnect_6/S01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_3_M00_AXI [get_bd_intf_pins axi_interconnect_3/M00_AXI] [get_bd_intf_pins axi_interconnect_4/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_3_M00_AXI] [get_bd_intf_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/S_AXI_MM_P_0] [get_bd_intf_pins axi_interconnect_3/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_4_M00_AXI [get_bd_intf_pins axi_interconnect_4/M00_AXI] [get_bd_intf_pins mpsoc_ss/S_AXI_HP0_FPD]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_7_M00_AXI [get_bd_intf_pins axi_interconnect_4/S04_AXI] [get_bd_intf_pins axi_interconnect_7/M00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_7_M00_AXI] [get_bd_intf_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/S_AXI_MM_P_1] [get_bd_intf_pins axi_interconnect_7/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_8_M00_AXI [get_bd_intf_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/M00_AXI3] [get_bd_intf_pins mpsoc_ss/S_AXI_HP2_FPD_0]
  connect_bd_intf_net -intf_net hdmi_input_M_AXI2 [get_bd_intf_pins axi_interconnect_3/S00_AXI] [get_bd_intf_pins hdmi_input/M_AXI2]
  connect_bd_intf_net -intf_net hdmi_input_M_AXI_0 [get_bd_intf_pins axi_interconnect_7/S00_AXI] [get_bd_intf_pins hdmi_input/M_AXI_0]
  ...
  connect_bd_intf_net -intf_net mpsoc_ss_M01_AXI1 [get_bd_intf_pins axi_intc_1/s_axi] [get_bd_intf_pins mpsoc_ss/M01_AXI1]
  ...
  connect_bd_intf_net -intf_net mpsoc_ss_M19_AXI_0 [get_bd_intf_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/S_AXI_CTRL1] [get_bd_intf_pins mpsoc_ss/M19_AXI_0]
  connect_bd_intf_net -intf_net s_axi_CTRL_0_1 [get_bd_intf_pins hdmi_input/s_axi_CTRL_0] [get_bd_intf_pins mpsoc_ss/M22_AXI_0]
  connect_bd_intf_net -intf_net s_axi_CTRL_1_1 [get_bd_intf_pins hdmi_input/s_axi_CTRL_1] [get_bd_intf_pins mpsoc_ss/M20_AXI_0]
  connect_bd_intf_net -intf_net s_axi_CTRL_2_1 [get_bd_intf_pins hdmi_input/s_axi_CTRL_2] [get_bd_intf_pins mpsoc_ss/M21_AXI_0]
  ...
  connect_bd_intf_net -intf_net vcu_0_M_AXI_DEC0 [get_bd_intf_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/S00_AXI2] [get_bd_intf_pins vcu_0/M_AXI_DEC0]
  connect_bd_intf_net -intf_net vcu_0_M_AXI_DEC1 [get_bd_intf_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/S00_AXI] [get_bd_intf_pins vcu_0/M_AXI_DEC1]
  connect_bd_intf_net -intf_net vcu_0_M_AXI_ENC0 [get_bd_intf_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/S00_AXI3] [get_bd_intf_pins vcu_0/M_AXI_ENC0]
  connect_bd_intf_net -intf_net vcu_0_M_AXI_ENC1 [get_bd_intf_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/S00_AXI1] [get_bd_intf_pins vcu_0/M_AXI_ENC1]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets vid_phy_controller_vid_phy_status_sb_rx] [get_bd_intf_pins hdmi_input/SB_STATUS] [get_bd_intf_pins rx_hdmi_hb_0/status_sb]
  ...
  connect_bd_net -net Net [get_bd_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/ACLK] [get_bd_pins axi_intc_1/s_axi_aclk] [get_bd_pins axi_interconnect_3/ACLK] [get_bd_pins axi_interconnect_3/M00_ACLK] [get_bd_pins axi_interconnect_3/S00_ACLK] [get_bd_pins axi_interconnect_4/ACLK] [get_bd_pins axi_interconnect_4/M00_ACLK] [get_bd_pins axi_interconnect_4/S00_ACLK] [get_bd_pins axi_interconnect_4/S01_ACLK] [get_bd_pins axi_interconnect_4/S02_ACLK] [get_bd_pins axi_interconnect_4/S03_ACLK] [get_bd_pins axi_interconnect_4/S04_ACLK] [get_bd_pins axi_interconnect_5/ACLK] [get_bd_pins axi_interconnect_5/M00_ACLK] [get_bd_pins axi_interconnect_5/S00_ACLK] [get_bd_pins axi_interconnect_6/ACLK] [get_bd_pins axi_interconnect_6/M00_ACLK] [get_bd_pins axi_interconnect_6/S00_ACLK] [get_bd_pins axi_interconnect_6/S01_ACLK] [get_bd_pins axi_interconnect_7/ACLK] [get_bd_pins axi_interconnect_7/M00_ACLK] [get_bd_pins axi_interconnect_7/S00_ACLK] [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins hdmi_input/clk_300M] [get_bd_pins hdmi_output/clk_300M] [get_bd_pins mpsoc_ss/s_axi_hpc0_fpd_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins vcu_0/m_axi_dec_aclk] [get_bd_pins vcu_0/m_axi_enc_aclk] [get_bd_pins vcu_0/m_axi_mcu_aclk]
  ...
  connect_bd_net -net hdmi_input_dout_0 [get_bd_pins axi_intc_1/intr] [get_bd_pins hdmi_input/dout_0]
  ...
  connect_bd_net -net mpsoc_ss_gpio [get_bd_pins gpio_aresetn/Din] [get_bd_pins hdmi_input/Din] [get_bd_pins hdmi_output/Din] [get_bd_pins mpsoc_ss/gpio] [get_bd_pins vcu_rst/Din]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/ARESETN] [get_bd_pins axi_intc_1/s_axi_aresetn] [get_bd_pins axi_interconnect_3/ARESETN] [get_bd_pins axi_interconnect_3/M00_ARESETN] [get_bd_pins axi_interconnect_3/S00_ARESETN] [get_bd_pins axi_interconnect_4/ARESETN] [get_bd_pins axi_interconnect_4/M00_ARESETN] [get_bd_pins axi_interconnect_4/S00_ARESETN] [get_bd_pins axi_interconnect_4/S01_ARESETN] [get_bd_pins axi_interconnect_4/S02_ARESETN] [get_bd_pins axi_interconnect_4/S03_ARESETN] [get_bd_pins axi_interconnect_4/S04_ARESETN] [get_bd_pins axi_interconnect_5/ARESETN] [get_bd_pins axi_interconnect_5/M00_ARESETN] [get_bd_pins axi_interconnect_5/S00_ARESETN] [get_bd_pins axi_interconnect_6/ARESETN] [get_bd_pins axi_interconnect_6/M00_ARESETN] [get_bd_pins axi_interconnect_6/S00_ARESETN] [get_bd_pins axi_interconnect_6/S01_ARESETN] [get_bd_pins axi_interconnect_7/ARESETN] [get_bd_pins axi_interconnect_7/M00_ARESETN] [get_bd_pins axi_interconnect_7/S00_ARESETN] [get_bd_pins hdmi_input/aresetn_1] [get_bd_pins hdmi_input/aresetn_300M] [get_bd_pins hdmi_output/aresetn_300M] [get_bd_pins mpsoc_ss/reset_333] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  connect_bd_net -net sensor_iic_0_iic2intc_irpt [get_bd_pins interrupts/In1] [get_bd_pins sensor_iic_0/iic2intc_irpt]
  connect_bd_net -net sync_ip_0_host_irq [get_bd_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/host_irq] [get_bd_pins interrupts1/In0]
  connect_bd_net -net sync_ip_1_host_irq [get_bd_pins LLP2_PHASE2_LOW_LATENCY_BLOCK/host_irq1] [get_bd_pins interrupts1/In1]
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData0] [get_bd_addr_segs LLP2_PHASE2_LOW_LATENCY_BLOCK/sync_ip_0/S_AXI_MM_0/Reg] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs LLP2_PHASE2_LOW_LATENCY_BLOCK/sync_ip_0/S_AXI_MM_1/Reg] -force
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces LLP2_PHASE2_LOW_LATENCY_BLOCK/sync_ip_0/Master_0] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x000100000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces LLP2_PHASE2_LOW_LATENCY_BLOCK/sync_ip_0/Master_0] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces LLP2_PHASE2_LOW_LATENCY_BLOCK/sync_ip_0/Master_0] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces LLP2_PHASE2_LOW_LATENCY_BLOCK/sync_ip_0/Master_0] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces LLP2_PHASE2_LOW_LATENCY_BLOCK/sync_ip_0/Master_1] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces LLP2_PHASE2_LOW_LATENCY_BLOCK/sync_ip_0/Master_1] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces LLP2_PHASE2_LOW_LATENCY_BLOCK/sync_ip_0/Master_1] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces LLP2_PHASE2_LOW_LATENCY_BLOCK/sync_ip_0/Master_1] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  ...
  assign_bd_address -offset 0xA0052000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_intc_1/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0xA0054000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs LLP2_PHASE2_LOW_LATENCY_BLOCK/sync_ip_0/S_AXI_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0xA00C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_input/v_frmbuf_wr_1/s_axi_CTRL/Reg] -force
