...
################################################################
# This is a generated script based on design: vcu_uc2_llp2
#
...
# source vcu_uc2_llp2_script.tcl
...
proc create_hier_cell_hdmi_input { parentCell nameHier } {
  ...
  connect_bd_net -net aresetn_300M [get_bd_pins aresetn_300M] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins v_hdmi_rx_ss_0/s_axis_video_aresetn]
  ...
  connect_bd_net -net util_vector_logic_5_Res [get_bd_pins axis_register_slice_0/m_axis_tready] [get_bd_pins axis_register_slice_1/m_axis_tready] [get_bd_pins util_vector_logic_0/Res]
...
proc create_root_design { parentCell } {
  ...
  set clk_wiz_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz clk_wiz_3 ]
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {100.000} \
   CONFIG.CLKIN1_UI_JITTER {100.000} \
   CONFIG.CLKIN2_JITTER_PS {100.000} \
   CONFIG.CLKIN2_UI_JITTER {100.000} \
   CONFIG.CLKOUT1_JITTER {257.504} \
   CONFIG.CLKOUT1_PHASE_ERROR {339.017} \
   ...
   CONFIG.ENABLE_CLOCK_MONITOR {false} \
   CONFIG.JITTER_OPTIONS {PS} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {106.875} \
   CONFIG.MMCM_CLKIN1_PERIOD {3.333} \
   CONFIG.MMCM_CLKIN2_PERIOD {10.0} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {37.000} \
   CONFIG.MMCM_CLKOUT1_DIVIDE {1} \
   CONFIG.MMCM_CLKOUT2_DIVIDE {1} \
   CONFIG.MMCM_DIVCLK_DIVIDE {26} \
   CONFIG.MMCM_REF_JITTER1 {0.030} \
   CONFIG.MMCM_REF_JITTER2 {0.010} \
   CONFIG.NUM_OUT_CLKS {1} \
   CONFIG.PRIMITIVE {MMCM} \
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_interconnect_3/S00_AXI] [get_bd_intf_pins sync_ip_0/M_AXI_MM_0]
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins axi_interconnect_4/S00_AXI] [get_bd_intf_pins hdmi_input/M_AXI2]
connect_bd_intf_net -intf_net [get_bd_intf_nets S00_AXI_2] [get_bd_intf_pins hdmi_input/M_AXI2] [get_bd_intf_pins sync_ip_0/S_AXI_MM_P_0]
  connect_bd_intf_net -intf_net S00_AXI_3 [get_bd_intf_pins axi_interconnect_9/S00_AXI] [get_bd_intf_pins sync_ip_0/M_AXI_MM_1]
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins axi_interconnect_4/S01_AXI] [get_bd_intf_pins hdmi_input/M_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets S01_AXI_1] [get_bd_intf_pins hdmi_input/M_AXI] [get_bd_intf_pins sync_ip_0/S_AXI_MM_P_1]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets SB_STATUS_IN_1] [get_bd_intf_pins hdmi_output/SB_STATUS] [get_bd_intf_pins tx_hdmi_hb_0/status_sb]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_interconnect_1/M00_AXI] [get_bd_intf_pins axi_interconnect_8/S00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_2_M00_AXI [get_bd_intf_pins axi_interconnect_10/S00_AXI] [get_bd_intf_pins axi_interconnect_2/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_3_M00_AXI [get_bd_intf_pins axi_interconnect_3/M00_AXI] [get_bd_intf_pins mpsoc_ss/S_AXI_HP0_FPD]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_8_M00_AXI [get_bd_intf_pins axi_interconnect_8/M00_AXI] [get_bd_intf_pins sync_ip_0/S_AXI_MM_0]
  connect_bd_intf_net -intf_net axi_interconnect_9_M00_AXI [get_bd_intf_pins axi_interconnect_9/M00_AXI] [get_bd_intf_pins mpsoc_ss/S_AXI_HP1_FPD_0]
  ...
  connect_bd_intf_net -intf_net mig_sys_1 [get_bd_intf_ports mig_sys] [get_bd_intf_pins vcu_ddr4_controller_0/c0_sys]
  ...
  connect_bd_intf_net -intf_net mpsoc_ss_M14_AXI_0 [get_bd_intf_pins mpsoc_ss/M14_AXI_0] [get_bd_intf_pins sync_ip_0/S_AXI_CTRL]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets vid_phy_controller_vid_phy_status_sb_rx] [get_bd_intf_pins hdmi_input/SB_STATUS] [get_bd_intf_pins rx_hdmi_hb_0/status_sb]
  ...
  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_10/ARESETN] [get_bd_pins axi_interconnect_10/M00_ARESETN] [get_bd_pins axi_interconnect_10/S00_ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axi_interconnect_3/ARESETN] [get_bd_pins axi_interconnect_3/M00_ARESETN] [get_bd_pins axi_interconnect_3/S00_ARESETN] [get_bd_pins axi_interconnect_5/ARESETN] [get_bd_pins axi_interconnect_5/M00_ARESETN] [get_bd_pins axi_interconnect_5/S00_ARESETN] [get_bd_pins axi_interconnect_6/ARESETN] [get_bd_pins axi_interconnect_6/S00_ARESETN] [get_bd_pins axi_interconnect_7/ARESETN] [get_bd_pins axi_interconnect_7/S00_ARESETN] [get_bd_pins axi_interconnect_8/ARESETN] [get_bd_pins axi_interconnect_8/M00_ARESETN] [get_bd_pins axi_interconnect_8/S00_ARESETN] [get_bd_pins axi_interconnect_9/ARESETN] [get_bd_pins axi_interconnect_9/M00_ARESETN] [get_bd_pins axi_interconnect_9/S00_ARESETN] [get_bd_pins proc_sys_reset_3/interconnect_aresetn] [get_bd_pins sync_ip_0/s_axi_mm_aresetn]
  ...
  connect_bd_net -net Net [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_10/ACLK] [get_bd_pins axi_interconnect_10/M00_ACLK] [get_bd_pins axi_interconnect_10/S00_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins axi_interconnect_3/ACLK] [get_bd_pins axi_interconnect_3/M00_ACLK] [get_bd_pins axi_interconnect_3/S00_ACLK] [get_bd_pins axi_interconnect_4/ACLK] [get_bd_pins axi_interconnect_4/M00_ACLK] [get_bd_pins axi_interconnect_4/S00_ACLK] [get_bd_pins axi_interconnect_4/S01_ACLK] [get_bd_pins axi_interconnect_5/ACLK] [get_bd_pins axi_interconnect_5/M00_ACLK] [get_bd_pins axi_interconnect_5/S00_ACLK] [get_bd_pins axi_interconnect_6/ACLK] [get_bd_pins axi_interconnect_6/S00_ACLK] [get_bd_pins axi_interconnect_7/ACLK] [get_bd_pins axi_interconnect_7/S00_ACLK] [get_bd_pins axi_interconnect_8/ACLK] [get_bd_pins axi_interconnect_8/M00_ACLK] [get_bd_pins axi_interconnect_8/S00_ACLK] [get_bd_pins axi_interconnect_9/ACLK] [get_bd_pins axi_interconnect_9/M00_ACLK] [get_bd_pins axi_interconnect_9/S00_ACLK] [get_bd_pins clk_wiz_2/clk_out1] [get_bd_pins hdmi_input/clk_300M] [get_bd_pins hdmi_output/clk_300M] [get_bd_pins mpsoc_ss/clk_333] [get_bd_pins mpsoc_ss/s_axi_hpc0_fpd_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins proc_sys_reset_3/slowest_sync_clk] [get_bd_pins sync_ip_0/s_axi_ctrl_aclk] [get_bd_pins sync_ip_0/s_axi_mm_aclk] [get_bd_pins sync_ip_0/s_axi_mm_p_aclk] [get_bd_pins vcu_0/m_axi_dec_aclk] [get_bd_pins vcu_0/m_axi_enc_aclk] [get_bd_pins vcu_0/m_axi_mcu_aclk]
  ...
  connect_bd_net -net clk_wiz_2_locked [get_bd_pins clk_wiz_2/locked] [get_bd_pins proc_sys_reset_1/dcm_locked] [get_bd_pins proc_sys_reset_3/dcm_locked]
  connect_bd_net -net clk_wiz_3_clk_out1 [get_bd_pins clk_wiz_3/clk_out1] [get_bd_pins proc_sys_reset_4/slowest_sync_clk] [get_bd_pins vcu_0/pll_ref_clk]
  connect_bd_net -net clk_wiz_3_locked [get_bd_pins clk_wiz_3/locked] [get_bd_pins proc_sys_reset_4/dcm_locked]
  ...
  connect_bd_net -net mpsoc_ss_pl_resetn0_0 [get_bd_pins mpsoc_ss/pl_resetn0_0] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins proc_sys_reset_4/ext_reset_in]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_4/ARESETN] [get_bd_pins axi_interconnect_4/M00_ARESETN] [get_bd_pins axi_interconnect_4/S00_ARESETN] [get_bd_pins axi_interconnect_4/S01_ARESETN] [get_bd_pins hdmi_input/aresetn_300M] [get_bd_pins hdmi_output/aresetn_300M] [get_bd_pins mpsoc_ss/reset_333] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins sync_ip_0/s_axi_ctrl_aresetn] [get_bd_pins sync_ip_0/s_axi_mm_p_aresetn]
  ...
  connect_bd_net -net proc_sys_reset_4_interconnect_aresetn [get_bd_pins proc_sys_reset_3/ext_reset_in] [get_bd_pins proc_sys_reset_4/interconnect_aresetn]
  ...
  connect_bd_net -net sync_ip_0_host_irq [get_bd_pins interrupts1/In3] [get_bd_pins sync_ip_0/host_irq]
  ...
  connect_bd_net -net util_ds_buf_0_BUFG_O [get_bd_pins clk_wiz_2/clk_in1] [get_bd_pins clk_wiz_3/clk_in1] [get_bd_pins util_ds_buf_0/BUFG_O]
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces sync_ip_0/Master_0] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces sync_ip_0/Master_0] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces sync_ip_0/Master_0] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces sync_ip_0/Master_0] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces sync_ip_0/Master_1] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces sync_ip_0/Master_1] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces sync_ip_0/Master_1] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces sync_ip_0/Master_1] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData0] [get_bd_addr_segs sync_ip_0/S_AXI_MM_0/Reg] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs sync_ip_0/S_AXI_MM_1/Reg] -force
  ...
  assign_bd_address -offset 0xA00D1000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs sync_ip_0/S_AXI_CTRL/Reg] -force
