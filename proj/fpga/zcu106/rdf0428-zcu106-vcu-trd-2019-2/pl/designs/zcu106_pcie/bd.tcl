...
xilinx.com:ip:pcie4_uscale_plus:*\
user.org:user:pcie_reg_space_v1_0:*\
...
proc create_hier_cell_mpsoc_ss { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins axi_interconnect_5/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]
  ...
  connect_bd_net -net net_clk_wiz_clk_out1 [get_bd_pins clk_100M] [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins axi_interconnect_5/ACLK] [get_bd_pins axi_interconnect_5/M00_ACLK] [get_bd_pins axi_interconnect_5/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net net_rst_processor_1_100M_peripheral_aresetn [get_bd_pins aresetn_100M] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins axi_interconnect_5/M00_ARESETN] [get_bd_pins axi_interconnect_5/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net pl_ps_irq0_1 [get_bd_pins pl_ps_irq0] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net saxihp2_fpd_aclk_0_1 [get_bd_pins s_axi_hpc0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp3_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
...
# Hierarchical cell: PCIe_Subsystem
proc create_hier_cell_PCIe_Subsystem { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_PCIe_Subsystem() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir I -type rst sys_reset_0
  create_bd_pin -dir O us_user_lnk_up
  ...
  set_property -dict [ list \
   ...
   CONFIG.PF1_DEVICE_ID_mqdma {9034} \
   CONFIG.PF1_SUBSYSTEM_ID {4351} \
  ...
  set pcie4_uscale_plus_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:pcie4_uscale_plus pcie4_uscale_plus_0 ]
  set_property -dict [ list \
   ...
   CONFIG.PF1_DEVICE_ID {A883} \
   CONFIG.PF1_MSIX_CAP_PBA_BIR {BAR_1} \
   CONFIG.PF1_MSIX_CAP_PBA_OFFSET {9FE0} \
   CONFIG.PF1_MSIX_CAP_TABLE_BIR {BAR_1} \
   CONFIG.PF1_MSIX_CAP_TABLE_OFFSET {9000} \
   CONFIG.PF1_MSIX_CAP_TABLE_SIZE {1F} \
   CONFIG.PF1_SUBSYSTEM_ID {1351} \
   CONFIG.PF2_DEVICE_ID {0007} \
   CONFIG.PF3_DEVICE_ID {9634} \
  ...
  # Create instance: pcie_reg_space_v1_0_0, and set properties
  set pcie_reg_space_v1_0_0 [ create_bd_cell -type ip -vlnv user.org:user:pcie_reg_space_v1_0 pcie_reg_space_v1_0_0 ]
  ...
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins ref_clk] [get_bd_intf_pins util_ds_buf_0/CLK_IN_D]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins M_AXI_0] [get_bd_intf_pins dma_pcie/M_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_5_M00_AXI [get_bd_intf_pins axi_interconnect_5/M00_AXI] [get_bd_intf_pins pcie_reg_space_v1_0_0/s00_axi]
  connect_bd_intf_net -intf_net dma_pcie_M_AXI_LITE [get_bd_intf_pins axi_interconnect_5/S00_AXI] [get_bd_intf_pins dma_pcie/M_AXI_LITE]
  connect_bd_intf_net -intf_net dma_pcie_pcie4_cfg_control [get_bd_intf_pins dma_pcie/pcie4_cfg_control] [get_bd_intf_pins pcie4_uscale_plus_0/pcie4_cfg_control]
  connect_bd_intf_net -intf_net dma_pcie_pcie4_cfg_external_msix [get_bd_intf_pins dma_pcie/pcie4_cfg_external_msix] [get_bd_intf_pins pcie4_uscale_plus_0/pcie4_cfg_external_msix]
  connect_bd_intf_net -intf_net dma_pcie_pcie4_cfg_interrupt [get_bd_intf_pins dma_pcie/pcie4_cfg_interrupt] [get_bd_intf_pins pcie4_uscale_plus_0/pcie4_cfg_interrupt]
  connect_bd_intf_net -intf_net dma_pcie_s_axis_cc [get_bd_intf_pins dma_pcie/s_axis_cc] [get_bd_intf_pins pcie4_uscale_plus_0/s_axis_cc]
  connect_bd_intf_net -intf_net dma_pcie_s_axis_rq [get_bd_intf_pins dma_pcie/s_axis_rq] [get_bd_intf_pins pcie4_uscale_plus_0/s_axis_rq]
  connect_bd_intf_net -intf_net pcie4_uscale_plus_0_m_axis_cq [get_bd_intf_pins dma_pcie/m_axis_cq] [get_bd_intf_pins pcie4_uscale_plus_0/m_axis_cq]
  connect_bd_intf_net -intf_net pcie4_uscale_plus_0_m_axis_rc [get_bd_intf_pins dma_pcie/m_axis_rc] [get_bd_intf_pins pcie4_uscale_plus_0/m_axis_rc]
  connect_bd_intf_net -intf_net pcie4_uscale_plus_0_pcie4_cfg_fc [get_bd_intf_pins dma_pcie/pcie4_cfg_fc] [get_bd_intf_pins pcie4_uscale_plus_0/pcie4_cfg_fc]
  connect_bd_intf_net -intf_net pcie4_uscale_plus_0_pcie4_cfg_mesg_rcvd [get_bd_intf_pins dma_pcie/pcie4_cfg_mesg_rcvd] [get_bd_intf_pins pcie4_uscale_plus_0/pcie4_cfg_mesg_rcvd]
  connect_bd_intf_net -intf_net pcie4_uscale_plus_0_pcie4_cfg_mesg_tx [get_bd_intf_pins dma_pcie/pcie4_cfg_mesg_tx] [get_bd_intf_pins pcie4_uscale_plus_0/pcie4_cfg_mesg_tx]
  connect_bd_intf_net -intf_net pcie4_uscale_plus_0_pcie4_cfg_status [get_bd_intf_pins dma_pcie/pcie4_cfg_status] [get_bd_intf_pins pcie4_uscale_plus_0/pcie4_cfg_status]
  connect_bd_intf_net -intf_net s01_axi_1 [get_bd_intf_pins s01_axi] [get_bd_intf_pins pcie_reg_space_v1_0_0/s01_axi]

  # Create port connections
  connect_bd_net -net In7_1 [get_bd_pins In7] [get_bd_pins interrupts/In7]
  connect_bd_net -net axi_resetn_0_1 [get_bd_pins axi_resetn_0] [get_bd_pins pcie_reg_space_v1_0_0/s01_axi_aresetn]
  connect_bd_net -net dma_pcie_axi_aclk [get_bd_pins axi_aclk] [get_bd_pins axi_interconnect_5/ACLK] [get_bd_pins axi_interconnect_5/M00_ACLK] [get_bd_pins axi_interconnect_5/S00_ACLK] [get_bd_pins dma_pcie/axi_aclk] [get_bd_pins pcie_reg_space_v1_0_0/s00_axi_aclk]
  connect_bd_net -net dma_pcie_axi_aresetn [get_bd_pins axi_aresetn] [get_bd_pins axi_interconnect_5/ARESETN] [get_bd_pins axi_interconnect_5/M00_ARESETN] [get_bd_pins axi_interconnect_5/S00_ARESETN] [get_bd_pins dma_pcie/axi_aresetn] [get_bd_pins pcie_reg_space_v1_0_0/s00_axi_aresetn]
  connect_bd_net -net interrupts_dout [get_bd_pins dout] [get_bd_pins interrupts/dout]
  connect_bd_net -net pcie4_uscale_plus_0_phy_rdy_out [get_bd_pins dma_pcie/phy_rdy_out_sd] [get_bd_pins pcie4_uscale_plus_0/phy_rdy_out]
  connect_bd_net -net pcie4_uscale_plus_0_user_clk [get_bd_pins dma_pcie/user_clk_sd] [get_bd_pins pcie4_uscale_plus_0/user_clk]
  connect_bd_net -net pcie4_uscale_plus_0_user_reset [get_bd_pins dma_pcie/user_reset_sd] [get_bd_pins pcie4_uscale_plus_0/user_reset]
  connect_bd_net -net pcie_3port_switch_0_us_user_lnk_up [get_bd_pins us_user_lnk_up] [get_bd_pins dma_pcie/user_lnk_up_sd] [get_bd_pins pcie4_uscale_plus_0/user_lnk_up]
  connect_bd_net -net pcie_reg_space_v1_0_0_IRQ1_to_Host [get_bd_pins dma_pcie/usr_irq_req] [get_bd_pins pcie_reg_space_v1_0_0/IRQ1_to_Host]
  connect_bd_net -net pcie_reg_space_v1_0_0_IRQ1_to_PS [get_bd_pins interrupts/In0] [get_bd_pins pcie_reg_space_v1_0_0/IRQ1_to_PS]
  connect_bd_net -net pcie_reg_space_v1_0_0_IRQ2_to_PS [get_bd_pins interrupts/In1] [get_bd_pins pcie_reg_space_v1_0_0/IRQ2_to_PS]
  connect_bd_net -net pcie_reg_space_v1_0_0_IRQ3_to_PS [get_bd_pins interrupts/In2] [get_bd_pins pcie_reg_space_v1_0_0/IRQ3_to_PS]
  connect_bd_net -net pcie_reg_space_v1_0_0_IRQ4_to_PS [get_bd_pins interrupts/In3] [get_bd_pins pcie_reg_space_v1_0_0/IRQ4_to_PS]
  connect_bd_net -net s_axi_lite_aclk_0_1 [get_bd_pins s_axi_lite_aclk_0] [get_bd_pins pcie_reg_space_v1_0_0/s01_axi_aclk]
  connect_bd_net -net sys_reset_0_1 [get_bd_pins sys_reset_0] [get_bd_pins dma_pcie/sys_rst_n] [get_bd_pins pcie4_uscale_plus_0/sys_reset]
  connect_bd_net -net util_ds_buf_0_IBUF_DS_ODIV2 [get_bd_pins pcie4_uscale_plus_0/sys_clk] [get_bd_pins util_ds_buf_0/IBUF_DS_ODIV2]
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_pins pcie4_uscale_plus_0/sys_clk_gt] [get_bd_pins util_ds_buf_0/IBUF_OUT]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins dma_pcie/usr_irq_function_number] [get_bd_pins xlconstant_1/dout]
...
proc create_root_design { parentCell } {
  ...
  set pcie4_mgt_0_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:pcie_7x_mgt_rtl:1.0 pcie4_mgt_0_0 ]
  ...
  # Create instance: PCIe_Subsystem
  create_hier_cell_PCIe_Subsystem [current_bd_instance .] PCIe_Subsystem
  ...
  connect_bd_intf_net -intf_net PCIe_Subsystem_M_AXI_0 [get_bd_intf_pins PCIe_Subsystem/M_AXI_0] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net PCIe_Subsystem_pcie4_mgt_0 [get_bd_intf_ports pcie4_mgt_0_0] [get_bd_intf_pins PCIe_Subsystem/pcie4_mgt_0]
  ...
  connect_bd_intf_net -intf_net mpsoc_ss_M00_AXI1 [get_bd_intf_pins PCIe_Subsystem/s01_axi] [get_bd_intf_pins mpsoc_ss/M00_AXI1]
  connect_bd_intf_net -intf_net ref_clk_0_1 [get_bd_intf_ports ref_clk_0] [get_bd_intf_pins PCIe_Subsystem/ref_clk]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins axi_interconnect_2/S01_ACLK] [get_bd_pins axi_interconnect_3/ACLK] [get_bd_pins axi_interconnect_3/M00_ACLK] [get_bd_pins axi_interconnect_3/S00_ACLK] [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins mpsoc_ss/s_axi_hpc0_fpd_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins vcu_0/m_axi_dec_aclk] [get_bd_pins vcu_0/m_axi_enc_aclk] [get_bd_pins vcu_0/m_axi_mcu_aclk]
  connect_bd_net -net PCIe_Subsystem_axi_aclk [get_bd_pins PCIe_Subsystem/axi_aclk] [get_bd_pins axi_interconnect_0/S00_ACLK]
  connect_bd_net -net PCIe_Subsystem_axi_aresetn [get_bd_pins PCIe_Subsystem/axi_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN]
  connect_bd_net -net PCIe_Subsystem_us_user_lnk_up [get_bd_ports lnk_up_led] [get_bd_pins PCIe_Subsystem/us_user_lnk_up] [get_bd_pins mpsoc_ss/dcm_locked]
  connect_bd_net -net aresetn_100M [get_bd_pins PCIe_Subsystem/axi_resetn_0] [get_bd_pins mpsoc_ss/aresetn_100M]
  connect_bd_net -net clk_100M [get_bd_pins PCIe_Subsystem/s_axi_lite_aclk_0] [get_bd_pins mpsoc_ss/clk_100M] [get_bd_pins vcu_0/s_axi_lite_aclk]
  ...
  connect_bd_net -net gpio [get_bd_pins mpsoc_ss/gpio] [get_bd_pins vcu_rst/Din]
  connect_bd_net -net mpsoc_ss_pl_resetn0_0 [get_bd_pins mpsoc_ss/pl_resetn0_0] [get_bd_pins proc_sys_reset_1/ext_reset_in]
  connect_bd_net -net pl_ps_irq0_1 [get_bd_pins PCIe_Subsystem/dout] [get_bd_pins mpsoc_ss/pl_ps_irq0]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axi_interconnect_2/S01_ARESETN] [get_bd_pins axi_interconnect_3/ARESETN] [get_bd_pins axi_interconnect_3/M00_ARESETN] [get_bd_pins axi_interconnect_3/S00_ARESETN] [get_bd_pins mpsoc_ss/reset_333] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net -net sys_reset_0_1 [get_bd_ports perst_n] [get_bd_pins PCIe_Subsystem/sys_reset_0]
  connect_bd_net -net vcu_0_vcu_host_interrupt [get_bd_pins PCIe_Subsystem/In7] [get_bd_pins vcu_0/vcu_host_interrupt]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PCIe_Subsystem/dma_pcie/M_AXI_LITE] [get_bd_addr_segs PCIe_Subsystem/pcie_reg_space_v1_0_0/s00_axi/reg0] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces PCIe_Subsystem/dma_pcie/M_AXI] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces PCIe_Subsystem/dma_pcie/M_AXI] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces PCIe_Subsystem/dma_pcie/M_AXI] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces PCIe_Subsystem/dma_pcie/M_AXI] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0xB0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs PCIe_Subsystem/pcie_reg_space_v1_0_0/s01_axi/reg0] -force
