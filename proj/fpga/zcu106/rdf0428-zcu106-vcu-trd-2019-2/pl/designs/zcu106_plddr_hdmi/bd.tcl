...
################################################################
# This is a generated script based on design: zcu106_vcu_uc2
#
...
# source zcu106_vcu_uc2_script.tcl
...
set design_name zcu106_vcu_uc2
...
proc create_hier_cell_mpsoc_ss { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 7 -to 0 -type intr pl_ps_irq1
  ...
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins M00_AXI1] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net Conn25 [get_bd_intf_pins S_AXI_HPC1_FPD] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC1_FPD]
  ...
  connect_bd_net -net saxihp2_fpd_aclk_0_1 [get_bd_pins s_axi_hpc0_fpd_aclk] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins axi_interconnect/M05_ACLK] [get_bd_pins axi_interconnect/M06_ACLK] [get_bd_pins axi_interconnect/M07_ACLK] [get_bd_pins axi_interconnect/M09_ACLK] [get_bd_pins axi_interconnect/M10_ACLK] [get_bd_pins axi_interconnect/M13_ACLK] [get_bd_pins axi_interconnect/M14_ACLK] [get_bd_pins axi_interconnect/M15_ACLK] [get_bd_pins axi_interconnect/M16_ACLK] [get_bd_pins axi_interconnect/M17_ACLK] [get_bd_pins axi_interconnect/M19_ACLK] [get_bd_pins axi_interconnect/M20_ACLK] [get_bd_pins axi_interconnect/M21_ACLK] [get_bd_pins axi_interconnect/M22_ACLK] [get_bd_pins axi_interconnect/M23_ACLK] [get_bd_pins axi_interconnect/M24_ACLK] [get_bd_pins axi_interconnect/M25_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp3_fpd_aclk]
  connect_bd_net -net saxihpc0_fpd_aclk_1 [get_bd_pins clk_333] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc1_fpd_aclk]
...
proc create_hier_cell_hdmi_output { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_MAX_BITS_PER_COMPONENT {10} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.LAYER1_VIDEO_FORMAT {22} \
   CONFIG.LAYER2_VIDEO_FORMAT {22} \
   CONFIG.LAYER3_VIDEO_FORMAT {22} \
   CONFIG.LAYER4_VIDEO_FORMAT {22} \
   CONFIG.LAYER5_ALPHA {false} \
   CONFIG.LAYER5_VIDEO_FORMAT {23} \
   CONFIG.LAYER6_VIDEO_FORMAT {18} \
...
proc create_hier_cell_hdmi_input { parentCell nameHier } {
  ...
  set axi_data_fifo_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_data_fifo axi_data_fifo_1 ]
  set_property -dict [ list \
   CONFIG.WRITE_FIFO_DELAY {1} \
   CONFIG.WRITE_FIFO_DEPTH {512} \
 ] $axi_data_fifo_1
  ...
  set axi_data_fifo_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_data_fifo axi_data_fifo_2 ]
  set_property -dict [ list \
   CONFIG.WRITE_FIFO_DELAY {1} \
   CONFIG.WRITE_FIFO_DEPTH {512} \
 ] $axi_data_fifo_2
  ...
  set axi_data_fifo_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_data_fifo axi_data_fifo_3 ]
  set_property -dict [ list \
   CONFIG.WRITE_FIFO_DELAY {1} \
   CONFIG.WRITE_FIFO_DEPTH {512} \
 ] $axi_data_fifo_3
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins s_axi_CTRL1] [get_bd_intf_pins v_frmbuf_wr_3/s_axi_CTRL]
  ...
  connect_bd_intf_net -intf_net Conn9 [get_bd_intf_pins M_AXI3] [get_bd_intf_pins axi_data_fifo_3/M_AXI]
  ...
  connect_bd_net -net Net [get_bd_pins axi_data_fifo_3/aresetn] [get_bd_pins v_frmbuf_wr_3/ap_rst_n] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net aresetn_300M [get_bd_pins aresetn_300M] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins v_hdmi_rx_ss_0/s_axis_video_aresetn]
  connect_bd_net -net cable_detect [get_bd_pins cable_detect] [get_bd_pins v_hdmi_rx_ss_0/cable_detect]
  connect_bd_net -net clk_300M [get_bd_pins clk_300M] [get_bd_pins axi_data_fifo_0/aclk] [get_bd_pins axi_data_fifo_1/aclk] [get_bd_pins axi_data_fifo_2/aclk] [get_bd_pins axi_data_fifo_3/aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins axis_data_fifo_2/s_axis_aclk] [get_bd_pins axis_data_fifo_3/s_axis_aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins v_frmbuf_wr_0/ap_clk] [get_bd_pins v_frmbuf_wr_1/ap_clk] [get_bd_pins v_frmbuf_wr_2/ap_clk] [get_bd_pins v_frmbuf_wr_3/ap_clk] [get_bd_pins v_hdmi_rx_ss_0/s_axis_video_aclk] [get_bd_pins v_proc_ss_0/aclk_axis] [get_bd_pins v_proc_ss_0/aclk_ctrl]
  ...
  connect_bd_net -net rx_scaler_reset [get_bd_pins frmbuf_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins axis_data_fifo_2/s_axis_aresetn] [get_bd_pins axis_data_fifo_3/s_axis_aresetn] [get_bd_pins v_proc_ss_0/aresetn_ctrl]
  ...
  connect_bd_net -net util_vector_logic_5_Res [get_bd_pins axis_register_slice_0/m_axis_tready] [get_bd_pins axis_register_slice_1/m_axis_tready] [get_bd_pins axis_register_slice_2/m_axis_tready] [get_bd_pins axis_register_slice_3/m_axis_tready] [get_bd_pins util_vector_logic_1/Res]
  ...
  connect_bd_net -net v_frmbuf_wr_1_interrupt [get_bd_pins interrupt_0] [get_bd_pins v_frmbuf_wr_1/interrupt]
  ...
  connect_bd_net -net v_frmbuf_wr_2_interrupt [get_bd_pins interrupt1] [get_bd_pins v_frmbuf_wr_2/interrupt]
  connect_bd_net -net v_frmbuf_wr_2_s_axis_video_TREADY [get_bd_pins util_vector_logic_2/Op1] [get_bd_pins v_frmbuf_wr_2/s_axis_video_TREADY]
  connect_bd_net -net v_frmbuf_wr_3_interrupt [get_bd_pins interrupt2] [get_bd_pins v_frmbuf_wr_3/interrupt]
  connect_bd_net -net v_frmbuf_wr_3_s_axis_video_TREADY [get_bd_pins util_vector_logic_1/Op2] [get_bd_pins v_frmbuf_wr_3/s_axis_video_TREADY]
...
proc create_hier_cell_gpio_aresetn { parentCell nameHier } {
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_o [get_bd_pins Din] [get_bd_pins rx_scaler_reset/Din] [get_bd_pins tx_frmbuf_rd_aresetn_1/Din]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKIN2_JITTER_PS {100.000} \
   CONFIG.CLKIN2_UI_JITTER {100.000} \
   CONFIG.CLKOUT1_JITTER {202.549} \
   CONFIG.CLKOUT1_PHASE_ERROR {358.423} \
   ...
   CONFIG.CLKOUT3_DRIVES {Buffer} \
   CONFIG.CLKOUT3_JITTER {90.657} \
   CONFIG.CLKOUT3_PHASE_ERROR {81.700} \
   CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {100.000} \
   CONFIG.CLKOUT3_USED {false} \
   CONFIG.ENABLE_CLOCK_MONITOR {false} \
   CONFIG.JITTER_OPTIONS {PS} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {99.000} \
   CONFIG.MMCM_CLKIN1_PERIOD {3.333} \
   CONFIG.MMCM_CLKIN2_PERIOD {10.0} \
  ...
  # Create instance: frmbuf_rst1, and set properties
  set frmbuf_rst1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice frmbuf_rst1 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {26} \
   CONFIG.DIN_TO {26} \
   CONFIG.DIN_WIDTH {95} \
  ...
  # Create instance: frmbuf_rst2, and set properties
  set frmbuf_rst2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice frmbuf_rst2 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {42} \
   CONFIG.DIN_TO {42} \
   CONFIG.DIN_WIDTH {95} \
  ...
  connect_bd_intf_net -intf_net S03_AXI_1 [get_bd_intf_pins axi_interconnect_4/S03_AXI] [get_bd_intf_pins hdmi_input/M_AXI1]
  connect_bd_intf_net -intf_net S04_AXI_1 [get_bd_intf_pins axi_interconnect_4/S04_AXI] [get_bd_intf_pins v_frmbuf_wr_0/m_axi_mm_video]
  connect_bd_intf_net -intf_net S05_AXI_1 [get_bd_intf_pins axi_interconnect_4/S05_AXI] [get_bd_intf_pins hdmi_input/M_AXI3]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets SB_STATUS_IN_1] [get_bd_intf_pins hdmi_output/SB_STATUS] [get_bd_intf_pins tx_hdmi_hb_0/status_sb]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_interconnect_1/M00_AXI] [get_bd_intf_pins mpsoc_ss/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net axi_interconnect_2_M00_AXI [get_bd_intf_pins axi_interconnect_2/M00_AXI] [get_bd_intf_pins mpsoc_ss/S_AXI_HP1_FPD_0]
  connect_bd_intf_net -intf_net axi_interconnect_4_M00_AXI [get_bd_intf_pins axi_interconnect_4/M00_AXI] [get_bd_intf_pins mpsoc_ss/S_AXI_HP2_FPD_0]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_5_M01_AXI [get_bd_intf_pins axi_interconnect_5/M01_AXI] [get_bd_intf_pins vcu_ddr4_controller_0/S_AXI_PORT2]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_7_M00_AXI [get_bd_intf_pins axi_interconnect_7/M00_AXI] [get_bd_intf_pins vcu_ddr4_controller_0/S_AXI_PORT1]
  connect_bd_intf_net -intf_net c0_sys_0_1 [get_bd_intf_ports mig_sys] [get_bd_intf_pins vcu_ddr4_controller_0/c0_sys]
  connect_bd_intf_net -intf_net hdmi_input_M_AXI6 [get_bd_intf_pins axi_interconnect_4/S02_AXI] [get_bd_intf_pins hdmi_input/M_AXI]
  ...
  connect_bd_intf_net -intf_net mpsoc_ss_M00_AXI1 [get_bd_intf_pins mpsoc_ss/M00_AXI1] [get_bd_intf_pins vcu_ddr4_controller_0/S_AXI_PORT3]
  ...
  connect_bd_intf_net -intf_net mpsoc_ss_M19_AXI_0 [get_bd_intf_pins mpsoc_ss/M19_AXI_0] [get_bd_intf_pins v_frmbuf_wr_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net mpsoc_ss_M20_AXI_0 [get_bd_intf_pins mpsoc_ss/M20_AXI_0] [get_bd_intf_pins v_frmbuf_rd_0/s_axi_CTRL]
  ...
  connect_bd_intf_net -intf_net mpsoc_ss_M24_AXI_0 [get_bd_intf_pins hdmi_input/s_axi_CTRL1] [get_bd_intf_pins mpsoc_ss/M24_AXI_0]
  ...
  connect_bd_intf_net -intf_net si570_user_1 [get_bd_intf_ports si570_user] [get_bd_intf_pins util_ds_buf_1/CLK_IN_D]
  connect_bd_intf_net -intf_net v_frmbuf_rd_0_m_axi_mm_video [get_bd_intf_pins axi_interconnect_0/S05_AXI] [get_bd_intf_pins v_frmbuf_rd_0/m_axi_mm_video]
  ...
  connect_bd_intf_net -intf_net vcu_0_M_AXI_DEC1 [get_bd_intf_pins axi_interconnect_7/S00_AXI] [get_bd_intf_pins vcu_0/M_AXI_DEC1]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets vid_phy_controller_vid_phy_status_sb_rx] [get_bd_intf_pins hdmi_input/SB_STATUS] [get_bd_intf_pins rx_hdmi_hb_0/status_sb]
  ...
  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axi_interconnect_5/ARESETN] [get_bd_pins axi_interconnect_5/M00_ARESETN] [get_bd_pins axi_interconnect_5/S00_ARESETN] [get_bd_pins axi_interconnect_6/ARESETN] [get_bd_pins axi_interconnect_6/S00_ARESETN] [get_bd_pins axi_interconnect_7/ARESETN] [get_bd_pins axi_interconnect_7/S00_ARESETN] [get_bd_pins proc_sys_reset_3/interconnect_aresetn]
  ...
  connect_bd_net -net Net [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axi_interconnect_0/S04_ACLK] [get_bd_pins axi_interconnect_0/S05_ACLK] [get_bd_pins axi_interconnect_4/ACLK] [get_bd_pins axi_interconnect_4/M00_ACLK] [get_bd_pins axi_interconnect_4/S00_ACLK] [get_bd_pins axi_interconnect_4/S01_ACLK] [get_bd_pins axi_interconnect_4/S02_ACLK] [get_bd_pins axi_interconnect_4/S03_ACLK] [get_bd_pins axi_interconnect_4/S04_ACLK] [get_bd_pins axi_interconnect_4/S05_ACLK] [get_bd_pins clk_wiz_2/clk_out1] [get_bd_pins hdmi_input/clk_300M] [get_bd_pins hdmi_output/clk_300M] [get_bd_pins mpsoc_ss/s_axi_hpc0_fpd_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins v_frmbuf_rd_0/ap_clk] [get_bd_pins v_frmbuf_wr_0/ap_clk]
  ...
  connect_bd_net -net aresetn_100M [get_bd_ports SI5319_RST] [get_bd_pins hdmi_input/s_axi_cpu_aresetn] [get_bd_pins hdmi_output/aresetn_100M] [get_bd_pins mpsoc_ss/aresetn_100M] [get_bd_pins vid_phy_controller/vid_phy_axi4lite_aresetn] [get_bd_pins vid_phy_controller/vid_phy_sb_aresetn]
  connect_bd_net -net clk_100M [get_bd_pins hdmi_input/s_axi_cpu_aclk] [get_bd_pins hdmi_output/clk_100M] [get_bd_pins mpsoc_ss/clk_100M] [get_bd_pins rx_hdmi_hb_0/status_sb_aclk] [get_bd_pins tx_hdmi_hb_0/status_sb_aclk] [get_bd_pins vcu_0/s_axi_lite_aclk] [get_bd_pins vid_phy_controller/drpclk] [get_bd_pins vid_phy_controller/vid_phy_axi4lite_aclk] [get_bd_pins vid_phy_controller/vid_phy_sb_aclk]
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins vcu_0/pll_ref_clk]
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins axi_interconnect_5/ACLK] [get_bd_pins axi_interconnect_5/M00_ACLK] [get_bd_pins axi_interconnect_5/S00_ACLK] [get_bd_pins axi_interconnect_6/ACLK] [get_bd_pins axi_interconnect_6/S00_ACLK] [get_bd_pins axi_interconnect_7/ACLK] [get_bd_pins axi_interconnect_7/S00_ACLK] [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins mpsoc_ss/clk_333] [get_bd_pins proc_sys_reset_3/slowest_sync_clk] [get_bd_pins vcu_0/m_axi_dec_aclk] [get_bd_pins vcu_0/m_axi_enc_aclk] [get_bd_pins vcu_0/m_axi_mcu_aclk]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins proc_sys_reset_3/dcm_locked]
  connect_bd_net -net clk_wiz_2_locked [get_bd_pins clk_wiz_2/locked] [get_bd_pins proc_sys_reset_1/dcm_locked]
  connect_bd_net -net frmbuf_rst1_Dout [get_bd_pins frmbuf_rst1/Dout] [get_bd_pins v_frmbuf_wr_0/ap_rst_n]
  connect_bd_net -net frmbuf_rst2_Dout [get_bd_pins frmbuf_rst2/Dout] [get_bd_pins v_frmbuf_rd_0/ap_rst_n]
  ...
  connect_bd_net -net hdmi_input_interrupt [get_bd_pins hdmi_input/interrupt] [get_bd_pins interrupts/In1]
  connect_bd_net -net hdmi_input_interrupt1 [get_bd_pins hdmi_input/interrupt1] [get_bd_pins interrupts1/In6]
  connect_bd_net -net hdmi_input_interrupt2 [get_bd_pins hdmi_input/interrupt2] [get_bd_pins interrupts1/In7]
  connect_bd_net -net hdmi_input_interrupt_0 [get_bd_pins hdmi_input/interrupt_0] [get_bd_pins interrupts1/In5]
  ...
  connect_bd_net -net mpsoc_ss_gpio [get_bd_pins frmbuf_rst1/Din] [get_bd_pins frmbuf_rst2/Din] [get_bd_pins gpio_aresetn/Din] [get_bd_pins hdmi_input/Din] [get_bd_pins hdmi_output/Din] [get_bd_pins mpsoc_ss/gpio] [get_bd_pins vcu_rst/Din]
  connect_bd_net -net mpsoc_ss_iic2intc_irpt [get_bd_pins interrupts/In5] [get_bd_pins mpsoc_ss/iic2intc_irpt]
  connect_bd_net -net mpsoc_ss_pl_resetn0_0 [get_bd_pins mpsoc_ss/pl_resetn0_0] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins proc_sys_reset_3/ext_reset_in]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axi_interconnect_0/S04_ARESETN] [get_bd_pins axi_interconnect_0/S05_ARESETN] [get_bd_pins axi_interconnect_4/ARESETN] [get_bd_pins axi_interconnect_4/M00_ARESETN] [get_bd_pins axi_interconnect_4/S00_ARESETN] [get_bd_pins axi_interconnect_4/S01_ARESETN] [get_bd_pins axi_interconnect_4/S02_ARESETN] [get_bd_pins axi_interconnect_4/S03_ARESETN] [get_bd_pins axi_interconnect_4/S04_ARESETN] [get_bd_pins axi_interconnect_4/S05_ARESETN] [get_bd_pins hdmi_input/aresetn_300M] [get_bd_pins hdmi_output/aresetn_300M] [get_bd_pins mpsoc_ss/reset_333] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_5/M01_ARESETN] [get_bd_pins axi_interconnect_6/M00_ARESETN] [get_bd_pins axi_interconnect_7/M00_ARESETN] [get_bd_pins mpsoc_ss/M00_ARESETN] [get_bd_pins proc_sys_reset_2/peripheral_aresetn]
  ...
  connect_bd_net -net util_ds_buf_0_BUFG_O [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins clk_wiz_2/clk_in1] [get_bd_pins util_ds_buf_0/BUFG_O]
  connect_bd_net -net util_ds_buf_1_IBUF_OUT [get_bd_pins util_ds_buf_0/BUFG_I] [get_bd_pins util_ds_buf_1/IBUF_OUT]
  connect_bd_net -net v_frmbuf_rd_0_interrupt [get_bd_pins interrupts1/In1] [get_bd_pins v_frmbuf_rd_0/interrupt]
  connect_bd_net -net v_frmbuf_wr_0_interrupt [get_bd_pins interrupts1/In2] [get_bd_pins v_frmbuf_wr_0/interrupt]
  ...
  connect_bd_net -net vcu_ddr4_controller_0_UsrClk [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_5/M01_ACLK] [get_bd_pins axi_interconnect_6/M00_ACLK] [get_bd_pins axi_interconnect_7/M00_ACLK] [get_bd_pins mpsoc_ss/M00_ACLK] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins vcu_ddr4_controller_0/S_Axi_Clk] [get_bd_pins vcu_ddr4_controller_0/phy_Clk]
  connect_bd_net -net vcu_ddr4_controller_0_phy_sRst [get_bd_pins vcu_ddr4_controller_0/S_Axi_Rst] [get_bd_pins vcu_ddr4_controller_0/phy_sRst]
  ...
  assign_bd_address -offset 0x004800000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces v_frmbuf_rd_0/Data_m_axi_mm_video] [get_bd_addr_segs vcu_ddr4_controller_0/S_AXI_PORT4/Reg] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI] -force
  assign_bd_address -offset 0x004800000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces vcu_0/Code] [get_bd_addr_segs vcu_ddr4_controller_0/S_AXI_PORT2/Reg] -force
  assign_bd_address -offset 0x004800000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces vcu_0/DecData0] [get_bd_addr_segs vcu_ddr4_controller_0/S_AXI_PORT0/Reg] -force
  assign_bd_address -offset 0x004800000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces vcu_0/DecData1] [get_bd_addr_segs vcu_ddr4_controller_0/S_AXI_PORT1/Reg] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData0] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData0] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData0] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData0] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_1/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_2/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_2/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_2/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_2/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_3/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_3/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_3/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_3/Data_m_axi_mm_video] [get_bd_addr_segs mpsoc_ss/zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI] -force
  assign_bd_address -offset 0x004800000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hdmi_output/v_frmbuf_rd_0/Data_m_axi_mm_video] [get_bd_addr_segs vcu_ddr4_controller_0/S_AXI_PORT4/Reg] -force
  assign_bd_address -offset 0x004800000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video1] [get_bd_addr_segs vcu_ddr4_controller_0/S_AXI_PORT4/Reg] -force
  assign_bd_address -offset 0x004800000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video2] [get_bd_addr_segs vcu_ddr4_controller_0/S_AXI_PORT4/Reg] -force
  assign_bd_address -offset 0x004800000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video3] [get_bd_addr_segs vcu_ddr4_controller_0/S_AXI_PORT4/Reg] -force
  assign_bd_address -offset 0x004800000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video4] [get_bd_addr_segs vcu_ddr4_controller_0/S_AXI_PORT4/Reg] -force
  assign_bd_address -offset 0xA00D0000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mpsoc_ss/hdmi_ctrl_iic/S_AXI/Reg] -force
  assign_bd_address -offset 0xA00B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_output/v_frmbuf_rd_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs v_frmbuf_rd_0/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0xA0120000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs v_frmbuf_wr_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_input/v_frmbuf_wr_1/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA0090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_input/v_frmbuf_wr_2/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA00A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_input/v_frmbuf_wr_3/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0xA00C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_output/v_mix_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA0040000 -range 0x00040000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_input/v_proc_ss_0/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0xA0200000 -range 0x00100000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs vcu_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x004800000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs vcu_ddr4_controller_0/S_AXI_PORT3/Reg] -force
  assign_bd_address -offset 0xA0130000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mpsoc_ss/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs vid_phy_controller/vid_phy_axi4lite/Reg] -force
