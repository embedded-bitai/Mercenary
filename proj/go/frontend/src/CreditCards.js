            ...
            <div className="form-row text-center">
                <button type="submit"
                        ...
                        onClick={()=>this.setState(
                            {useExisting:true})}>Use saved card?</button>
            </div>
            <hr />
        </div>
        ...
        if (user.loggedin === true) {
            remembercardcheck = <div className="form-row form-check text-center">
                <input className="form-check-input" type="checkbox"
                       value="" id="remembercardcheck" name='remember'
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-row">
                        <div className="col-lg-12 form-group">
                            ...
                            <input id="cc-name" name='name' className="form-control"
                    ...
                    <hr className="mb-4" />
                    <button type="submit"
                            className="btn btn-success btn-large" >{this.props.operation}</button>
                </form>
            </div>
        );
    }
    ...
    return (
        <div>
            ...
            <StripeProvider apiKey="pk_test_TYooMQauvdEDq54NiTphI7jx">
                <Elements>
                    <CCFormWithStripe user={props.user}
